...
public final class Stream extends QueueNode {
	...
	public void writeWordBigEndian(long i) {
		buffer[currentOffset++] = (byte) (i >> 8);
		buffer[currentOffset++] = (byte) i;
	}
	
	public void writeWordBigEndian(double i) {
		int result = (int) i;
		buffer[currentOffset++] = (byte) (result << 2);
	}
	
	public void writeDoubleInt(int value) {
	...
	public void writeDoubleWord(int i) { // writes a int packet
		buffer[currentOffset++] = (byte) (i >> 8);
		buffer[currentOffset++] = (byte) i;
	}
	...
	public static final BigInteger RSA_MODULUS = new BigInteger("");
