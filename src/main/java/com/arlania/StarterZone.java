...
public class StarterZone
{
    ...
    public static void unpack(TextDrawingArea[] tda)
    {
        ...
        addText(id, ""+id, fonts, 2, ORANGE, true, true);
        ...
        //progress bar get me rsinterface of this shit
   // System.out.println("prog:"+id); 
        addRectangle(id, 0, 0x000000, false, 102, 20);
        rs.child(frame++, id++, 146, 300);
        createProgressBar(16790);
        rs.child(frame++, 16790, 147, 301);
...
//System.out.println("cont:"+id);
    ...
    private static void createProgressBar(int id) {
        ...
        rs.width = 100;
        rs.height = 18;
//System.out.println("give me the damn id: " + id);
