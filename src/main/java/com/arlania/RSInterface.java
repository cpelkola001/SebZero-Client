...
import com.arlania.interfaces.CollectionLog;
import com.arlania.interfaces.DonatorInterface;
import com.arlania.interfaces.Event_chest;
import com.arlania.interfaces.Mini_me;
import com.arlania.interfaces.Motivational_Message;
import com.arlania.interfaces.NewEquipmentScreen;
import com.arlania.interfaces.PlayerPanel;

import static com.arlania.RSInterface.addRectangle;
import static com.arlania.Sprite.fetchSprite;

@SuppressWarnings("all")
public class RSInterface {
	/*
	 * 		String dir = "Interfaces/Forging/SPRITE";

		String title = "Item Forging";
		String possibleItemsTitle = "Possible Items";
		String requiredTitle = "Required Items";
		String outputTitle = "Result";
		String noteText = "Note: Forging has a 100% success rate.";

		addSprite(34001, 0, dir);
	 */
	...
	public static void wellOfGoodwill(TextDrawingArea[] TDA) {
		...
		interfaceId++;
		RSInterface.addSpriteLoader(interfaceId, 1252);
		RSInterface.setBounds(interfaceId, 12, 19, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoverButtonWSpriteLoader(interfaceId, 737, 15, 15, "Close Window", -1, interfaceId + 1, 1); // Close button.
		RSInterface.setBounds(interfaceId, 475, 28, children, Interface);
		...
		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "Well of Goodwill", TDA, 2, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 262, 29, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteLoader(interfaceId, 1253);
		RSInterface.setBounds(interfaceId, 25, 61, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Select a boost", TDA, 2, 0xFF981F, false, true);
		RSInterface.setBounds(interfaceId, 127, 68, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoverButtonWSpriteLoader(interfaceId, 1255, 276, 68, "Select boost", -1, interfaceId + 1, 1);
		RSInterface.setBounds(interfaceId, 35, 94, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1256, 276, 68, interfaceId + 1);
		RSInterface.setBounds(interfaceId, 35, 94, children, Interface);

		interfaceId += 2;
		children++;
		RSInterface.addHoverButtonWSpriteLoader(interfaceId, 1255, 276, 68, "Select boost", -1, interfaceId + 1, 1);
		RSInterface.setBounds(interfaceId, 35, 164, children, Interface);
		...
		children++;
		RSInterface.addHoverButtonWSpriteLoader(interfaceId, 1255, 276, 68, "Select boost", -1, interfaceId + 1, 1);
		RSInterface.setBounds(interfaceId, 35, 234, children, Interface);
		...
		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "+50% XP", TDA, 2, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 180, 100, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Gain +50% XP for 1 hour", TDA, 1, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 193, 117, children, Interface);
		
		interfaceId++;
		children++;
		RSInterface.itemGroup(interfaceId, 1, 3, 16, 16);
		RSInterface.setBounds(interfaceId, 45, 102, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1257, 43, 135, Interface, true);
		
		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1258, 43, 135, Interface, true);
		RSInterface.setSpriteLoadingBarPercentage(interfaceId, 0);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "0/0", TDA, 0, 0xFFFFFF, true, true);
		RSInterface.setBounds(interfaceId, 174, 140, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "50% drop rate boost", TDA, 2, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 180, 170, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Gain 50% drop rate for 1 hour", TDA, 1, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 193, 185, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1257, 43, 206, Interface, true);
		
		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1258, 43, 206, Interface, true);
		RSInterface.setSpriteLoadingBarPercentage(interfaceId, 0);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "0/0", TDA, 0, 0xFFFFFF, true, true);
		RSInterface.setBounds(interfaceId, 174, 211, children, Interface);
		
		interfaceId++;
		children++;
		RSInterface.itemGroup(interfaceId, 1, 3, 16, 16);
		RSInterface.setBounds(interfaceId, 45, 173, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Double MOB Points", TDA, 2, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 180, 241, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Gain double MOB points for 1 hour", TDA, 1, 0xFF981F, true, true);
		RSInterface.setBounds(interfaceId, 193, 256, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1257, 43, 277, Interface, true);
		
		interfaceId++;
		children++;
		RSInterface.addSpriteComplete(interfaceId, children, 1258, 43, 277, Interface, true);
		RSInterface.setSpriteLoadingBarPercentage(interfaceId, 0);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "0/0", TDA, 0, 0xFFFFFF, true, true);
		RSInterface.setBounds(interfaceId, 174, 282, children, Interface);
		
		interfaceId++;
		children++;
		RSInterface.itemGroup(interfaceId, 1, 3, 16, 16);
		RSInterface.setBounds(interfaceId, 45, 244, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteLoader(interfaceId, 1254);
		RSInterface.setBounds(interfaceId, 325, 61, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Donations", TDA, 2, 0xFF981F, false, true);
		RSInterface.setBounds(interfaceId, 371, 68, children, Interface);

		interfaceId++;
		children++;
		RSInterface Interface1 = RSInterface.addInterface(interfaceId);
		RSInterface.setBounds(interfaceId, 324, 89, children, Interface); // scrollTab1

		Interface1.totalChildren(22);

		Interface1.width = 143;
		Interface1.height = 217;
		Interface1.scrollMax = 450;

		for (int i = 0; i < 22; i++) {
			interfaceId++;
			RSInterface.addText(interfaceId, "Line #" + i, TDA, 0, 0xFF981F, true, true);
			Interface1.child(i, interfaceId, 71, 6 + i * 20);
		}
	}
	...
	public static void addTransparentSpriteWSpriteLoader1(int id, int spriteId, int opacity) {
		...
		tab.height = tab.sprite2.myHeight - 2;
		tab.drawsTransparent = true;
	}
	
	public static void raidInterface(TextDrawingArea[] tda) {
		RSInterface main = addInterface(29050);
		addTransparentSpriteWSpriteLoader(29051, 1271, 135);
		addTransparentSpriteWSpriteLoader(29052, 1272, 135);
	...
	public static void goodiebagInterface(TextDrawingArea[] tda) { // open urcache,.
		final int STARTING_POINT = 60500;
		RSInterface main = addInterface(STARTING_POINT);

		final int ROWS = 5;
		final int COLUMNS = 4;
		addSpriteLoader(STARTING_POINT + 1, 1260);
		addText(STARTING_POINT + 2, "@re1@SebZero @enc@1-20 @cya@Goodiebag", tda, 2, ColorConstants.ORANGE, false, true);
		addText(STARTING_POINT + 3, "Select a number\\n and then click\\n @gre@Claim prize!", tda, 2, ColorConstants.ORANGE, false, true);
		addHoverButtonWSpriteLoader(STARTING_POINT + 4, 1262, 88, 36, "@whi@Claim Prize!", -1, STARTING_POINT + 5, 1);
		addHoveredImageWSpriteLoader(STARTING_POINT + 5, 1263, 88, 36, STARTING_POINT + 6);
		addText(STARTING_POINT + 7, "Claim Prize", tda, 2, ColorConstants.ORANGE, false, true);
		addText(STARTING_POINT + 8, "20 Prizes!", tda, 2, ColorConstants.ORANGE, false, true);
		addText(STARTING_POINT + 10, "Top Prize! - 1\\nLegendary Prize's! - 2\\nUltimate Prize's! - 5\\nGreat Prize's! - 6\\nGood Prize's! - 6", tda, 1, ColorConstants.ORANGE, true, false);
		...
		for (int y = 0; y < ROWS; y++) {
			...
			for (int x = 0; x < COLUMNS; x++) {
				int id = x + y * COLUMNS;
				addButtonWSpriteLoader(STARTING_POINT + 11 + id, 1261, "Choose"); // this is why i needed the order so i can remember easily
	...
	public static void upgradeInt(TextDrawingArea[] tda) {
		...
		interfaceId++;
		RSInterface.addSpriteLoader(interfaceId, 1246); // Background.
		RSInterface.setBounds(interfaceId, x, y, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoverSpriteLoaderButton(interfaceId, 737, 15, 15, "Close Window", -1, interfaceId + 1, 1); // Close button.
		...
		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "Item upgrade machine", tda, 2, 0xff9933, true, true);
		...
		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Items required:", tda, 1, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 270, y + 41, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoverSpriteLoaderButton(interfaceId, 1249, 83, 20, "Upgrade", -1, interfaceId + 1, 1);
		RSInterface.setBounds(interfaceId, x + 273, y + 208, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1251, 83, 20, interfaceId + 1);
		RSInterface.setBounds(interfaceId, x + 273, y + 208, children, Interface);

		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "Upgrade", tda, 2, 0xff9933, true, true);
		...
		interfaceId++;
		children++;
		RSInterface.addHoverSpriteLoaderButton(interfaceId, 1247, 62, 20, "View weaponry upgrades", -1, interfaceId + 1, 1);
		RSInterface.setBounds(interfaceId, x + 9, y + 40, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1248, 62, 20, interfaceId + 1);
		RSInterface.setBounds(interfaceId, x + 9, y + 40, children, Interface);

		interfaceId += 2;
		children++;
		RSInterface.addHoverSpriteLoaderButton(interfaceId, 1247, 62, 20, "View armor upgrades", -1, interfaceId + 1, 1);
		...
		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "Weaponry", tda, 0, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 40, y + 44, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Armour", tda, 0, 0xff9933, true, true);
		...
		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Safe item:", tda, 1, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 283, y + 156, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteLoader(interfaceId, 1250);
	...
	public static void perkTree(TextDrawingArea[] TDA) {
		int interfaceId = 51500;
		int children = 0;
		int totalChildren = 5;
		RSInterface Interface = RSInterface.addInterface(interfaceId);
		RSInterface.setChildren(totalChildren, Interface);
		...
		interfaceId++;
		RSInterface.addSpriteLoader(interfaceId, 1241);
		RSInterface.setBounds(interfaceId, 5, 20, children, Interface);
		
		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Blood Well Perks", TDA, 2, 0xffb000, true, true);
		RSInterface.setBounds(interfaceId, 265, 25, children, Interface);
		
		interfaceId++;
		children++;
		RSInterface.addHoverButtonWSpriteLoader(interfaceId, 737, 15, 15, "Close Window", -1, interfaceId + 1, 1); // Close button.
		RSInterface.setBounds(interfaceId, 479, 24, children, Interface);
		...
		children++;
		RSInterface Interface1 = RSInterface.addInterface(interfaceId);
		RSInterface.setBounds(interfaceId, 4, 44, children, Interface); // scrollTab1

		Interface1.totalChildren(42);

		Interface1.width = 475;
		Interface1.height = 268;
		Interface1.scrollMax = 600;
		
		interfaceId++;
		RSInterface.addHDCacheSprite(interfaceId, 1245);
		Interface1.child(0, interfaceId, 3, 5);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood Hero I", 36, 38);
		Interface1.child(1, interfaceId, 243, 546);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood Hero II", 36, 38);
		Interface1.child(2, interfaceId, 243, 485);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood treasurer I", 36, 38);
		Interface1.child(3, interfaceId, 361, 506);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood treasurer II", 36, 38);
		Interface1.child(4, interfaceId, 427, 506);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood Master I", 36, 38);
		Interface1.child(5, interfaceId, 362, 433);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood Master II", 36, 38);
		Interface1.child(6, interfaceId, 420, 398);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood Master III", 36, 38);
		Interface1.child(7, interfaceId, 303, 398);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood slayer I", 36, 38);
		Interface1.child(8, interfaceId, 362, 369);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Blood slayer II", 36, 38);
		Interface1.child(9, interfaceId, 119, 505);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(10, interfaceId, 54, 469);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(11, interfaceId, 119, 428);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(12, interfaceId, 54, 397);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(13, interfaceId, 119, 359);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(14, interfaceId, 303, 467);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(15, interfaceId, 420, 467);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(16, interfaceId, 427, 552);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(17, interfaceId, 177, 397);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(18, interfaceId, 216, 434);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(19, interfaceId, 270, 434);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(20, interfaceId, 13, 519);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(21, interfaceId, 176, 475);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(22, interfaceId, 10, 430);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(23, interfaceId, 242, 396);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(24, interfaceId, 198, 354);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(25, interfaceId, 285, 354);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(26, interfaceId, 59, 330);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(27, interfaceId, 421, 331);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(28, interfaceId, 59, 277);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(29, interfaceId, 321, 330);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(30, interfaceId, 321, 277);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(31, interfaceId, 362, 307);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(32, interfaceId, 156, 324);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(33, interfaceId, 238, 324);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(34, interfaceId, 198, 304);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(35, interfaceId, 96, 242);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(36, interfaceId, 421, 281);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(37, interfaceId, 119, 305);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(38, interfaceId, 150, 275);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(39, interfaceId, 361, 506 + 46);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(40, interfaceId, 150 + 32, 275 - 33);
		
		interfaceId++;
		RSInterface.addButtonHDWSpriteLoader(interfaceId, 1242, "Coming Soon", 36, 38);
		Interface1.child(41, interfaceId, 18, 365);
	}
	...
	public static void refferal(TextDrawingArea[] TDA) {
        ...
        interfaceId++;
        RSInterface.addSpriteLoader(interfaceId, 1237);
        ...
        interfaceId++;
        children++;
        RSInterface.addHoverButtonWSpriteLoader(interfaceId, 1238, 120, 31, "Confirm", -1, interfaceId + 1, 1);
        RSInterface.setBounds(interfaceId, 51, 213, children, Interface);
        
        interfaceId++;
        children++;
        RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1239, 120, 31, interfaceId + 1);
        RSInterface.setBounds(interfaceId, 51, 213, children, Interface);
        ...
        for(int i = 0; i < 10; i++) {
            ...
            interfaceId++;
            RSInterface.addSpriteLoader(interfaceId, 1240);
    ...
    public static void squealOfFortuneTab(final TextDrawingArea[] tda) {
        final RSInterface tab = addTabInterface(47500);
        addText(47501, "", tda, 2, 16750899, false, true);
        RSInterface.addButtonWSpriteLoader(47502, 1236, "Open Squeal Of Fortune");
        RSInterface.addSpriteLoader(47503, 1235);
        RSInterface.addSpriteLoader(47504, 1233);
        RSInterface.addSpriteLoader(47505, 1234);
        addText(47565, "0", tda, 0, 16750899, false, true);
        tab.totalChildren(7);
        tab.child(0, 47501, 21, 128);
        tab.child(1, 47502, 7, 3);
        tab.child(2, 47503, 7, 129);
        tab.child(3, 47504, 7, 123);
        tab.child(4, 47506, 10, 123);
        tab.child(5, 47505, 7, 251);
        tab.child(6, 47565, 63, 99);
        final RSInterface infoList = addTabInterface(47506);
        infoList.height = 134;
        infoList.width = 158;
        infoList.scrollMax = 135;
        infoList.totalChildren(52);
        addText(47513, "USEFUL LINKS:", tda, 2, 16750899, false, true);
        infoList.totalChildren(52);
        infoList.child(0, 47513, 5, 8);
        int Ypos = 28;
        int frameID = 1;
        for (int iD = 47514; iD <= 47564; ++iD) {
            addHoverText(iD, "", "Visit link", tda, 0, 16711680, false, true, 150);
            infoList.child(frameID, iD, 4, Ypos);
            ++frameID;
            Ypos += 13;
            ++Ypos;
        }
    ...
    private static void wheelOfFortune(TextDrawingArea[] font) {
        final int STARTING_POINT = 21350;
        RSInterface main = addInterface(STARTING_POINT);

        addSpriteLoader(STARTING_POINT + 1, 1192); // 1184 -> 1192
        addWheel(STARTING_POINT + 2, 210, 210, 2, 0x3f372c, 255, 2, true, 10, 1193);
        main.totalChildren(13);
        main.child(0, STARTING_POINT + 1, 50, 10);
        main.child(1, STARTING_POINT + 2, 80, 65);
        addHoverableSprite(STARTING_POINT + 3, 1195, 1196, true, "Spin Wheel");
        ...
        addSpriteLoader(STARTING_POINT + 6, 1194);
        main.child(5, STARTING_POINT + 6, 301, 168);
        addSpriteLoader(STARTING_POINT + 7, 1198);
        ...
        addTextComponent(STARTING_POINT + 11, "Squeal Of Fortune", fonts, 2, ColorConstants.RS_ORANGE, true, true, 0, 0);
        ...
        addSpriteLoader(STARTING_POINT + 21, 1197);
        ...
        addHoverableSprite(STARTING_POINT + 25, 1195, 1196, true, "Spin Again!");
    ...
    private static void bestInSlot() {
        ...
        String[] data = {"Attack bonus", "Stab: +0", "Slash: +0", "Crush: +0", "Magic: +0", "Range: +0", "Defence bonus", "Stab: +0", "Slash: +0", "Crush: +0", "Magic: +0", "Range: +0", "Other bonus", "Melee strength: +0", "Ranged strength: +0", "Prayer: +0", "Magic damage: +0.0%", "@yel@Attack speed: FAST"};
        RSInterface main = addInterface(STARTING_POINT);
        main.totalChildren(18 + data.length);
        main.child(0, STARTING_POINT + 1, 20, 10);
        addSpriteLoader(STARTING_POINT + 1, 1200); // 1239 -> 1200
        ...
        for (int i = 0; i < 10; i++) {
            ...
            addHoverableConfigSprite(STARTING_POINT + 2 + i, 1203, 1204, true, "Select", i, 3000);
        ...
        scroll.width = 164;
        scroll.height = 257;
        scroll.scrollMax = 3990;

        scroll.totalChildren(301);
        yPos = 2;
        for (int i = 0; i < 150; i++) {
            addHoverableConfigSprite(STARTING_POINT + 14 + i, 1201, 1202, true, "Select", i, 3200);
        ...
        int index = 0;
        for (int i = 0; i < 6; i += 2) {
            addHoverableConfigSprite(STARTING_POINT + 337 + index, 1206 + i, 1207 + i, true, "Select", i, 3300);
    ...
    public static void addModel(int interfaceId, int width, int height, int itemId, int zoom, int contentType) {
        ...
        rsi.mediaID = itemId;
        rsi.modelZoom = zoom;
        rsi.modelRotation1 = def.rotationX;
        rsi.modelRotation2 = def.rotationY;
        rsi.width = width;
        rsi.height = height;
    ...
    public static void lootingBag(TextDrawingArea[] tda) {
		RSInterface tab = addInterface(26900);
		//addSprite(29701, 0, "looting/BAG");
		addSprite(29701, 0, "Interfaces/looting/BAG");
		addHoverButton(29702, "Interfaces/looting/BAG", 1, 16, 16, "Close", 0, 26903, 1);
		addHoveredButton(29703, "Interfaces/looting/BAG", 2, 16, 16, 26904);
		addText(29705, "Looting bag", tda, 2, 0xFF9900, true, true);
		itemGroup(29706, 4, 7, 13, 0/*, false, true*/);
		addText(29707, "Value: 0 coins", tda, 0, 0xFF9900, true, true);
		tab.totalChildren(6);
		tab.child(0, 29701, 9, 21);
		tab.child(1, 29702, 168, 4);
		tab.child(2, 29703, 168, 4);
		tab.child(3, 29705, 95, 4);
		tab.child(4, 29706, 12, 23);
		tab.child(5, 29707, 95, 250);
	}
	
	public static void lootingBagBank(TextDrawingArea[] tda) {
		RSInterface tab = addInterface(29800);
		//addSprite(29701, 0, "looting/BAG");
		addSprite(29801, 0, "Interfaces/looting/BAG");
		addHoverButton(29802, "Interfaces/looting/BAG", 1, 16, 16, "Close", 0, 29803, 1);
		addHoveredButton(29803, "Interfaces/looting/BAG", 2, 16, 16, 29804);
		addText(29805, "Looting bag", tda, 2, 0xFF9900, true, true);
		itemGroup(29806, 4, 7, 13, 0/*, false, true*/);
		addText(29807, "Value: 0 coins", tda, 0, 0xFF9900, true, true);
		addButton(29808, 3, "Interfaces/looting/BAG", "Deposit All");
		tab.totalChildren(7);
		tab.child(0, 29801, 9, 21);
		tab.child(1, 29802, 168, 4);
		tab.child(2, 29803, 168, 4);
		tab.child(3, 29805, 95, 4);
		tab.child(4, 29806, 12, 23);
		tab.child(5, 29807, 95, 250);
		tab.child(6, 29808, 15, 2);
	}
	...
	public static void drawChatBoxOverlay(TextDrawingArea[] tda) {
		int interfaceId = 59800;
		int totalChildren = 3;
		int children = 0;
		RSInterface main = addInterface(interfaceId);
		main.totalChildren(totalChildren);
		
		interfaceId++;
		addRectangle(interfaceId, 215, 0xFFFFFF, true, 59, 35);
		main.child(children, interfaceId, 4, 94);
		
		interfaceId++;
		children++;
		addText(interfaceId, "Time left:", tda, 1, ColorConstants.YELLOW, false, true);
		main.child(children, interfaceId, 7, 98);
		
		interfaceId++;
		children++;
		addText(interfaceId, "NaN", tda, 1, ColorConstants.YELLOW, false, true);
		main.child(children, interfaceId, 7, 112);
	}
	
	public static void drawDPSOverlay(TextDrawingArea[] tda) {
		RSInterface main = addInterface(23998);
		addText(23999, "DPS: 0", tda, 1, ColorConstants.ORANGE, false, true);
		main.totalChildren(1);
		main.child(0, 23999, 400, 313);
	}
	
	private static void playerPanelInterface(TextDrawingArea[] tda) {
        RSInterface tab = addTabInterface(639);
        RSInterface scroll = addTabInterface(15016);
        addText(39155, "@or2@SebZero RSPS", tda, 1, ColorConstants.BLUE, false, true);
        addSpriteLoader(39156, 1171);
        addSpriteLoader(39156, 1171);
        addSpriteLoader(39157, 1165);//hmm what are these?
        addButtonWSpriteLoader(39158, 1170, "View Achievement Interface");
        addButtonWSpriteLoader(23839, 1155, "Refresh");
        addButtonWSpriteLoader(23843, 1191, "Collection log");
        
        addButtonWSpriteLoader(23835, 1167, "Players tab");
        addButtonWSpriteLoader(23836, 1168, "World events tab");
        addButtonWSpriteLoader(23837, 1166, "Points & Statistics tab");
        addButtonWSpriteLoader(23838, 1169, "Kill Data");
        scroll.totalChildren(75);
        scroll.width = 172; scroll.height = 196; scroll.scrollMax = 1050;
        tab.totalChildren(13);
        tab.child(0, 39155, 60, 1);
        tab.child(1, 39156, 0, 230); // HHHHHHHHHHHHHHHHHHHHHH
        tab.child(2, 39157, 0, 35); 
        tab.child(3, 39158, 7, 237);
        tab.child(11, 23839, 160, 240);
        tab.child(12, 23843, 35, 239);
        tab.child(4, 15016, 0, 35);
        tab.child(5, 23835, 5, 14); // Players tab
        tab.child(7, 23836, 48, 14); // World events tab.
        tab.child(8, 23837, 91, 14); // Points & Statistics tab.
        tab.child(9, 23838, 134, 14); // Kill Data tab.
        tab.child(10, 39156, 0, 32);
    ...
    public static CacheArchive spriteArchive;
	 ...
	 */
	  ...
	  private static void itemHoverInterface(TextDrawingArea[] font) {
	        //final int STARTING_POINT = 25750;
	        final int STARTING_POINT = 23000;
	        RSInterface main = addInterface(STARTING_POINT);
	        addOutlinedColorBox(STARTING_POINT + 1, 0x534a40, 145, 145, 200);
	        addText(STARTING_POINT + 2, "Item name", font, 0, 0xff9040, true, true);
	        addText(STARTING_POINT + 3, "Attack", font, 0, 0xff9040, false, true);
	        addText(STARTING_POINT + 4, "Defence", font, 0, 0xff9040, false, true);
	        addText(STARTING_POINT + 5, "Stab:\\nSlash:\\nCrush:\\nMagic:\\nRange:", font, 0, 0xff9040, false, true);
	        addText(STARTING_POINT + 6, "0\\n0\\n0\\n0\\n0", font, 0, 0xffffff, true, true);
	        addText(STARTING_POINT + 7, "0\\n0\\n0\\n0\\n0", font, 0, 0xffffff, true, true);
	        addText(STARTING_POINT + 8, "Other Bonuses", font, 0, 0xff9040, false, true);
	        addText(STARTING_POINT + 9, "Strength Bonus:\\nPrayer Bonus:", font, 0, 0xff9040, false, true);
	        addText(STARTING_POINT + 10, "0\\n0", font, 0, 0xffffff, true, true);
	        addLine(STARTING_POINT + 11, 0xFFFFFF, 32);
	        addLine(STARTING_POINT + 12, 0xFFFFFF, 41);
	        addLine(STARTING_POINT + 13, 0xFFFFFF, 74);
	        int x = 8, y = 8;
	        main.totalChildren(13);
	        main.child(0, STARTING_POINT + 1, x, y);
	        main.child(1, STARTING_POINT + 2, 72 + x, 2 + y);
	        main.child(2, STARTING_POINT + 3, 48 + x, 16 + y);
	        main.child(3, STARTING_POINT + 4, 93 + x, 16 + y);
	        main.child(4, STARTING_POINT + 5, 2 + x, 30 + y);
	        main.child(5, STARTING_POINT + 6, 64 + x, 30 + y);
	        main.child(6, STARTING_POINT + 7, 114 + x, 30 + y);
	        main.child(7, STARTING_POINT + 8, 2 + x, 97 + y);
	        main.child(8, STARTING_POINT + 9, 2 + x, 110 + y);
	        main.child(9, STARTING_POINT + 10, 110 + x, 110 + y);
	        main.child(10, STARTING_POINT + 11, 48 + x, 27 + y);
	        main.child(11, STARTING_POINT + 12, 93 + x, 27 + y);
	        main.child(12, STARTING_POINT + 13, 2 + x, 109 + y);

	        main = addInterface(23020);
	        addOutlinedColorBox(23021, 0x534a40, 145, 16, 200);
	        addText(23022, "Press <col=65280>CTRL <col=ffffff>to view stats", font, 0, 0xB7B7B7, false, true);
	        main.totalChildren(3);
	        main.child(0, 23021, x, y);
	        main.child(1, STARTING_POINT + 2, 72 + x, 2 + y);
	        main.child(2, 23022, 2 + x, 16 + y);

	        main = addInterface(23085);
	        addOutlinedColorBox(23086, 0x534a40, 170, 110, 200);
	        //addText(23087, "Should list info about the item", font, 0, 0xffffff, false, true);
	        addText(23087, "", font, 0, 0xffffff, false, true);
	        x = 8;
	        y = 8;
	        main.totalChildren(4);
	        main.child(0, 23086, x, y);
	        main.child(1, STARTING_POINT + 2, 72 + x, 2 + y);
	        main.child(2, 23087, 4 + x, 17 + y);
	        main.child(3, 23088, x, 75);
	    ...
	    public static void addLine(int id, int color, int width) {
	        RSInterface widget = addInterface(id);
	        widget.width = width;
	        widget.enabledColor = color;
	        widget.type = 24;
	        widget.contentType = 0;
	    }

	private static void forgingInterface(TextDrawingArea[] tda) {
		 ...
		 */
		int id = 34002;
		addText(id++, title, tda, 2, ColorConstants.ORANGE, true);
		addText(id++, possibleItemsTitle, tda, 2, ColorConstants.ORANGE, true);
		addText(id++, requiredTitle, tda, 2, ColorConstants.ORANGE, true);
		addText(id++, outputTitle, tda, 2, ColorConstants.ORANGE, true);
		addText(id++, noteText, tda, 1, ColorConstants.WHITE, true);

		/*
		 * Possible items on the left
		 */
		RSInterface possibleItems = addInterface(34007);
		addToItemGroup(34008, 4, 20, 4, 6, true, "Select", null, null);
		possibleItems.totalChildren(1);
		possibleItems.child(0, 34008, 5, 5);
		possibleItems.width = 144;
		possibleItems.height = 234;
		possibleItems.scrollMax = 900;

		/*
		 * Required items on the top right
		 */
		RSInterface requiredItems = addInterface(34009);
		addToItemGroup(34010, 6, 10, 2, 6, false, null, null, null);
		requiredItems.totalChildren(1);
		requiredItems.child(0, 34010, 21, 5);
		requiredItems.width = 231;
		requiredItems.height = 93;
		requiredItems.scrollMax = 100;

		/*
		 * Resulting item in bottom right
		 */
		addToItemGroup(34011, 1, 1, 1, 1, true, "Forge", null, null);
		...
		main.child(0, id++, 10, 10);
		main.child(1, id++, 252, 20);
		main.child(2, id++, 105, 55);
		main.child(3, id++, 336, 55);
		main.child(4, id++, 343, 177);
		main.child(5, id++, 343, 280);
		main.child(6, id++, 22, 70);

		id = 34009;
		main.child(7, id++, 205, 72);

		id = 34011;
		main.child(8, id++, 325, 210);
	}
	...
	private static void mysteryBoxViewer(TextDrawingArea[] tda) { // lol nice sprites xD
		...
		addHoverButtonWSpriteLoader(48036, 1164, 90, 25, "Open", -1, 48037, 1);
		addHoveredImageWSpriteLoader(48037, 1163, 90, 25, 48038);
		
		addHoverButtonWSpriteLoader(48039, 1164, 90, 25, "Open All", -1, 48040, 1);
		addHoveredImageWSpriteLoader(48040, 1163, 90, 25, 48041);
	...
	public static void dailyReward(TextDrawingArea[] tda) {
		...
		addText(child++, "@gre@Today", tda, 2, 0xff7000, false);
		addText(child++, "@red@Tomorrow", tda, 2, 0xff7000, false);
	...
	private static void mysteryBoxViewerOwner(TextDrawingArea[] tda) { // lol nice sprites xD
		RSInterface main = addInterface(58030);
		addSpriteLoader(58031, 1162);
		addText(58032, "Common Rewards (90%)", tda, 0, 0x92d397, true, true);
		addText(58033, "Uncommon Rewards (9%)", tda, 0, 0xd3c692, true, true);
		addText(58034, "Rare Rewards (1%)", tda, 0, 0xbb92d3, true, true);
		addText(58035, "Mbox Name", tda, 1, 0xff8624, false, true);
		
		addHoverButtonWSpriteLoader(58036, 1164, 90, 25, "Open", -1, 48037, 1);
		addHoveredImageWSpriteLoader(58037, 1163, 90, 25, 48038);
		
		addHoverButtonWSpriteLoader(58039, 1164, 90, 25, "Open All", -1, 55040, 1);
		addHoveredImageWSpriteLoader(58040, 1163, 90, 25, 58041);
		
		addText(58042, "Open ", tda, 0, 0xff8624, true, true);
		addText(58043, "Open All", tda, 0, 0xff8624, true, true);
		addButtonWSpriteLoader(58044, 34, "Close Window", 16, 16);

	//	addText(48044, "Mystery Box Interface", tda, 1, ColorConstants.YELLOW, true, true);
		addToItemGroup(58045, 1, 1, 1, 1, true, new String[] {null, null, null, null, null});
		main.totalChildren(16);
		main.child(0, 58031, 10, 10);
		main.child(1, 58050, 5, 151);
		main.child(2, 58060, 162, 151);
		main.child(3, 58070, 322, 151);
		main.child(4, 58032, 90, 132);
		main.child(5, 58033, 250, 132);
		main.child(6, 58034, 410, 132);
		main.child(7, 58035, 107, 69);
		main.child(8, 58036, 286, 65);
		main.child(9, 58037, 286, 65);
		main.child(10, 58039, 386, 65);
		main.child(11, 58040, 386, 65);
		main.child(12, 58042, 330, 72);
		main.child(13, 58043, 431, 72);
		main.child(14, 58044, 263+210, 19);
		main.child(15, 58045, 31, 61);
		
		RSInterface commonScroll = addInterface(58050);
		commonScroll.width = 150;
		commonScroll.height = 144;
		commonScroll.scrollMax = 500;
		addToItemGroup(58051, 3, 100, 5, 6, true, new String[] {null, null, null, null, null});
		commonScroll.totalChildren(1);
		commonScroll.child(0, 58051, 18, 3);
		RSInterface mediumScroll = addInterface(58060);
		mediumScroll.width = 150;
		mediumScroll.height = 144;
		mediumScroll.scrollMax = 500;
		mediumScroll.totalChildren(1);
		mediumScroll.child(0, 58061, 18, 3);
		addToItemGroup(58061, 3, 50, 5, 6, true, new String[] {null, null, null, null, null});
		RSInterface rareScroll = addInterface(58070);
		rareScroll.width = 150;
		rareScroll.height = 144;
		rareScroll.scrollMax = 500;
		rareScroll.totalChildren(1);
		rareScroll.child(0, 58071, 18, 3);
		addToItemGroup(58071, 3, 50, 5, 6, true, new String[] {null, null, null, null, null});
	}
	...
	public static void dropChecker(TextDrawingArea[] tda) {
		int inter = 35000;

		RSInterface main = addInterface(inter++);
		String dir = "Interfaces/Drop/SPRITE";

		/*
		 * Main interface
		 */
		addSprite(inter++, 0, dir);

		String title = "Drop Table";
		String leftHeader = "NPC's";
		String buttonText = "Search NPC";

		/*
		 * Titles
		 */
		addText(inter++, title, tda, 2, ColorConstants.ORANGE, true, true);
		addText(inter++, leftHeader, tda, 2, ColorConstants.ORANGE, true, true);
		addText(inter++, buttonText, tda, 2, ColorConstants.ORANGE, true, true);

		/*
		 * Search button
		 */
		addHoverButton(35005, dir, 1, 159, 29, "Search NPC", 0, 35006, 1);
		addHoveredButton(35006, dir, 2, 159, 29, 35007);

		/*
		 * NPC list
		 */
		RSInterface npcList = addInterface(35008);
		npcList.totalChildren(150);
		for (int i = 0; i < 50; i++) {
			addHoverButton(35051 + i, dir, i % 2 == 0 ? 3 : 4, 156, 22, "Select", -1, 35101 + i, 1);
			addHoveredButton(35101 + i, dir, 5, 156, 22, 35049);
			addText(35151 + i, "", tda, 1, 0xff981f, false, true);
			npcList.child(i, 35051 + i, 0, i * 15);
			npcList.child(i + 50, 35101 + i, 0, i * 15);
			npcList.child(i + 100, 35151 + i, 2, i * 15);
		}
		npcList.width = 140;
		npcList.height = 204;
		npcList.scrollMax = 750;

		String quantityTitle = "QTY";
		String rateTitle = "RATE";
		String myRateTitle = "MY RATE";
		 ...
		 * Titles
		 */
		addText(inter++, quantityTitle, tda, 2, ColorConstants.YELLOW, false, true);
		addText(inter++, rateTitle, tda, 2, ColorConstants.YELLOW, false, true);
		addText(inter++, myRateTitle, tda, 2, ColorConstants.LIME_GREEN, false, true);

		/*
		 * Drop list
		 */
		RSInterface dropList = addInterface(35700);
		dropList.totalChildren(254);

		for (int i = 0; i < 50; i++) {
			addSprite(35701 + i, i % 2 == 0 ? 6 : 7, dir);
			dropList.child(i, 35701 + i, 2, i * 33);
		}

		for (int i = 50; i < 101; i++) {
			addText(35701 + i, "", tda, 1, 0xFFFAFA, true, true);
			dropList.child(i, 35701 + i, 157, (i - 50) * 33 + 9);
		}

		for (int i = 101; i < 152; i++) {
			addText(35701 + i, "", tda, 1, 0xFFFAFA, true, true);
			dropList.child(i, 35701 + i, 202, (i - 101) * 33 + 9);
		}

		for (int i = 152; i < 203; i++) {
			addText(35701 + i, "", tda, 1, 0x32CD32, true, true);
			dropList.child(i, 35701 + i, 260, (i - 152) * 33 + 9);
		}

		addToItemGroup(35905, 1, 50, 1, 1, false, null, null, null);
		dropList.child(203, 35905, 7, 0);

		for (int i = 0; i < 50; i++) {
			addText(35906 + i, "", tda, 0, ColorConstants.ORANGE, true, true);
			dropList.child(i + 204, 35906 + i, 94, i * 33 + 11);
		}

		dropList.width = 292;
		dropList.height = 236;
		dropList.scrollMax = 1600;

		/*
		 * Close button
		 */
		addHoverButton(35970, dir, 8, 16, 16, "Close", 0, 35971, 1);
		addHoveredButton(35971, dir, 9, 16, 16, 35972);

		int child = 0; inter = 35001;
		main.totalChildren(13);
		main.child(child++, inter++, 14, 15);

		// Search button
		main.child(child++, 35005, 22, 283);
		main.child(child++, 35006, 22, 283);

		main.child(child++, inter++, 260, 25);
		main.child(child++, inter++, 100, 55);
		main.child(child++, inter++, 123, 290);

		main.child(child++, 35008, 23, 75);

		main.child(child++, 35205, 330, 55);
		main.child(child++, 35206, 371, 55);
		main.child(child++, 35207, 420, 55);

		main.child(child++, 35700, 184, 75);
		main.child(child++, 35970, 475, 25);
		main.child(child++, 35971, 475, 25);
	}

    private static void raidRewards() {
        final int STARTING_POINT = 27830;
        RSInterface main = addInterface(STARTING_POINT);
        addSpriteLoader(STARTING_POINT + 1, 1129);
        main.totalChildren(4);
        ...
        addTextComponent(STARTING_POINT + 3, "Yu-Gi-Oh Raids", fonts, 2, ColorConstants.RS_ORANGE, false, true, 0, 0);
    ...
    private static void raidOverlay() {
        int STARTING_POINT = 27800;
        int childId = 0;
        RSInterface main = addInterface(STARTING_POINT++);

        main.totalChildren(6);

        addTransparentSpriteWSpriteLoader(STARTING_POINT, 1128, 150);
        main.child(childId++, STARTING_POINT++, 0, 64);

        for (int i = 0, y = 67; i < 5; i++, y += 15) {
            addText(STARTING_POINT, "", fonts, 0, ColorConstants.WHITE, false, true);
            main.child(childId++, STARTING_POINT++, 2, y);
        }
    }
    ...
    private static void raidLobby() {
        ...
        addSpriteLoader(STARTING_POINT + 1, 1119); // 1217
        main.totalChildren(42);
        main.child(0, STARTING_POINT + 1, 1, 28);

        addTextComponent(STARTING_POINT + 2, "Yu-Gi-Oh Raids", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(1, STARTING_POINT + 2, 214, 38);
        addTextComponent(STARTING_POINT + 3, "Raid Difficulty", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(2, STARTING_POINT + 3, 380, 70);
        addTextComponent(STARTING_POINT + 4, "Description", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(3, STARTING_POINT + 4, 389, 190);
        addTextComponent(STARTING_POINT + 5, "Party", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(4, STARTING_POINT + 5, 56, 71);

        addHoverableConfigSprite(STARTING_POINT + 6, 1120, 1121, true, "Select", 0, 3000);
        main.child(5, STARTING_POINT + 6, 355, 92);
        addHoverableConfigSprite(STARTING_POINT + 7, 1120, 1121, true, "Select", 1, 3000);
        ...
        main.child(9, STARTING_POINT + 10, 355, 213);
        addHoverableSprite(STARTING_POINT + 11, 1126, 1127, true, "@whi@Start Raid");
        main.child(10, STARTING_POINT + 11, 145, 66);
        addHoverableSprite(STARTING_POINT + 12, 1124, 1125, true, "@whi@Join Party");
        main.child(11, STARTING_POINT + 12, 145, 231);
        addHoverableSprite(STARTING_POINT + 13, 1124, 1125, true, "@whi@Leave Party");
        main.child(12, STARTING_POINT + 13, 248, 231);
        addHoverableSprite(STARTING_POINT + 14, 1124, 1125, true, "@whi@Create Party");
        main.child(13, STARTING_POINT + 14, 145, 262);
        addHoverableSprite(STARTING_POINT + 15, 1124, 1125, true, "@whi@Disband Party");
        main.child(14, STARTING_POINT + 15, 248, 262);
        addTextComponent(STARTING_POINT + 16, "Join Party", fonts, 0, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(15, STARTING_POINT + 16, 166, 240);
        addTextComponent(STARTING_POINT + 17, "Leave Party", fonts, 0, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(16, STARTING_POINT + 17, 265, 239);
        addTextComponent(STARTING_POINT + 18, "Create Party", fonts, 0, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(17, STARTING_POINT + 18, 161, 270);
        addTextComponent(STARTING_POINT + 19, "Disband Party", fonts, 0, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(18, STARTING_POINT + 19, 262, 270);
        addTextComponent(STARTING_POINT + 20, "Start", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(19, STARTING_POINT + 20, 234, 130);
        addTextComponent(STARTING_POINT + 21, "Raid!", fonts, 2, ColorConstants.SNOW_WHITE, false, true, 0, 0);
        main.child(20, STARTING_POINT + 21, 236, 144);
        int y = 90;
        for (int i = 0; i < 10; i++) {
            addSpriteLoader(STARTING_POINT + 22 + i, i % 2 == 0 ? 1122 : 1123);
            main.child(21 + i, STARTING_POINT + 22 + i, 13, y);
            addTextComponent(STARTING_POINT + 32 + i, "", fonts, 0, ColorConstants.RS_ORANGE, false, true, 0, 0);
            main.child(31 + i, STARTING_POINT + 32 + i, 15, y + 5);
            y += 20;
        }

        addCloseButton(STARTING_POINT + 42);
        main.child(41, STARTING_POINT + 42, 484, 37);
    ...
    public static void addProperConfigButton(int id, int sprite, int selectedSprite, String
        ...
        if (sprite != -1) {
            ...
            tab.enabledSprite = SpriteLoader.sprites[selectedSprite];
        }
        tab.width = tab.disabledSprite.myWidth;
        tab.height = tab.disabledSprite.myHeight;
        tab.tooltip = tooltip;
    ...
    public static void addSlider(int id, int minValue, int maxValue, int defaultValue, int backgroundSprite, int handleSprite, String tooltip) {
        ...
        Sprite handle = SpriteLoader.sprites[handleSprite];
    ...
    public static RSInterface addTextComponent(int id, String text, TextDrawingArea tda[], int idx, int color, boolean center,
	...
	public static void newTeleport(TextDrawingArea[] tda) {
		int inter = 63000;

		RSInterface main = addInterface(inter++);
		String dir = "Interfaces/Teleport/SPRITE";

		// Main interface
		addSprite(inter++, 0, dir);

		// Interface title
		addText(inter++, "Teleportation Menu", tda, 2, 0xff981f, true, true);

		// Text above teleports
		addText(inter++, "Available Teleports", tda, 2, 0xff981f, true, true);

		// Text above description
		addText(inter++, "Description", tda, 2, 0xff981f, true, true);

		// Teleport button
		addHoverButton(inter++, dir, 1, 105, 25, "Teleport", 0, 63006, 1);
		addHoveredButton(63006, dir, 2, 105, 25, 63007);

		inter = 63008;

		// Teleport button text
		addText(inter++, "Teleport", tda, 0, 0xff981f, true);

		// Previous teleport button
		addHoverButton(inter++, dir, 1, 105, 25, "Previous teleport", 0, 63010, 1);
		addHoveredButton(63010, dir, 2, 105, 25, 63011);

		inter = 63012;

		// Previous teleport button text
		addText(inter++, "Previous Teleport", tda, 0, 0xff981f, true);

		// Category config buttons
		String[] tabNames = {"Beginner", "Medium", "Hardened", "Expert", "Maniac", "Minigames"};
		for (int i = 0; i < tabNames.length; ++i) {
			addConfigButton(63013 + i, 63000, 3, 4, dir, 69, 20, tabNames[i], i, 5, 1106);
		}

		inter = 63019;

		// Category config button text
		addText(inter++, tabNames[0], tda, 0, 0xff981f, true);
		addText(inter++, tabNames[1], tda, 0, 0xff981f, true);
		addText(inter++, tabNames[2], tda, 0, 0xff981f, true);
		addText(inter++, tabNames[3], tda, 0, 0xff981f, true);
		addText(inter++, tabNames[4], tda, 0, 0xff981f, true);
		addText(inter++, tabNames[5], tda, 0, 0xff981f, true);

		// Available teleport buttons
		RSInterface scroll = addInterface(inter++);
		scroll.totalChildren(100);
		for (int i = 0; i < 50; i++) {
			addButton(63051 + i, i % 2 == 0 ? 5 : 6, dir, "Select", 146, 20);
			addText(63151 + i, "Rock Crabs", tda, 1, 0xff981f, false, true);
			scroll.child(i, 63051 + i, 0, i * 18);
			scroll.child(i + 50, 63151 + i, 2, i * 18 + 1);
		}
		scroll.width = 130;
		scroll.height = 213;
		...
		// Description text
		for (int i = 0; i < 6; i++) {
			addText(inter++, "test " + i, tda, 0, 0xff981f, true);
		}

		addToItemGroup(inter++, 6, 1, 12, 6, false, "", "", "");
		...
		int child = 0; inter = 63001;
		main.totalChildren(32);
		main.child(child++, inter++, 35, 13);
		main.child(child++, inter++, 255, 23);
		main.child(child++, inter++, 119, 81);
		main.child(child++, inter++, 401, 129);
		main.child(child++, inter++, 212, 254);
		main.child(child++, inter++, 212, 254);

		inter = 63008;
		main.child(child++, inter++, 264, 261);
		main.child(child++, inter++, 212, 284);
		main.child(child++, inter++, 212, 284);

		inter = 63012;
		main.child(child++, inter++, 264, 291);

		int x = 47, y = 29;
		for (int i = 0; i < tabNames.length; ++i) {
			main.child(child++, 63013 + i, + x + (i * 70), 24 + y);
		}

		inter = 63019;
		main.child(child++, inter++, 82, 58);
		main.child(child++, inter++, 151, 58);
		main.child(child++, inter++, 222, 58);
		main.child(child++, inter++, 290, 58);
		main.child(child++, inter++, 360, 58);
		main.child(child++, inter++, 430, 58);
		main.child(child++, inter++, 47, 98);

		main.child(child++, inter++, 402, 160);
		main.child(child++, inter++, 402, 180);
		main.child(child++, inter++, 402, 200);
		main.child(child++, inter++, 402, 220);
		main.child(child++, inter++, 402, 240);
		main.child(child++, inter++, 402, 260);
		main.child(child++, inter++, 205, 85);
		main.child(child++, inter++, 200, 145);
		main.child(child++, 35255, 452, 23);
	}
	...
	private static void dropTableCheckerInterface(TextDrawingArea[] rsFont) {
		...
		addText(37602, "NPC Drop Table Checker", 0xFFFAFA, true, true, -1, 2);
		...
		setBounds(37603, 476, 20, 2, main_widget);
		setBounds(37604, 476, 20, 3, main_widget);
		...
		addText(37914, "0.16%\\n@blu@1/400", 0xFFFFFF, true, true, -1, 1);
		...
		// addText(37926, "0.1%", 0xFFFAFA, true, true, -1, 1);
		...
		addToItemGroup(37915, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37915, xPosition, 7, 70, item_widget);
		xPosition += 39;

		addToItemGroup(37916, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37916, xPosition, 7, 71, item_widget);
		xPosition += 39;

		addToItemGroup(37917, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37917, xPosition, 7, 72, item_widget);
		xPosition += 39;

		addToItemGroup(37918, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37918, xPosition, 7, 73, item_widget);
		xPosition += 39;

		addToItemGroup(37919, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37919, xPosition, 7, 74, item_widget);
		xPosition += 39;

		addToItemGroup(37920, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37920, xPosition, 7, 75, item_widget);
		xPosition += 39;

		addToItemGroup(37921, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
		setBounds(37921, xPosition, 7, 76, item_widget);
		xPosition += 39;

		addToItemGroup(37922, 1, 60, 8, 8, allowActions, "Disable collectors pickup", null, null);
	...
	public static void bossTeles(TextDrawingArea[] tda) {
		...
		addText(36805, "Teleports", tda, 2, 0xFFA500, true, true);
		addText(36806, "Npc's", tda, 2, 0xFFA500, true, true);
		...
		for (int i = 0; i < 15; i++) {
			String[] names = { "Starter zone", "Defiler", "Frost Dragon", "Sirenic Ogres", "Hercules", "Lucario",
					"Hades", "Charizard", "Hellfire Wizards", "Jinni", "Godzilla", "Great Olm",
					"Cerberus", "Zeus", "Infartico", "" };
	...
	public static void xmasOptionInterface(TextDrawingArea[] tda) {
		...
		addText(61603, "Christmas Grinch Options", 0xed5844, true, true, 100, tda, 2);
		addText(61609, "Choose Blue Grinch", 0x2070cc, true, true, 100, tda, 2);
		addText(61610, "Choose Red Grinch", 0xe8a430, true, true, 100, tda, 2);
		addText(61611, "Choose Green Grinch", 0x32bf1c, true, true, 100, tda, 2);

		addText(61612, "Event bonuses:", 0x2070cc, false, true, 100, tda, 2);
		addText(61613, "15% Droprate bonus", 0x2070cc, false, true, 100, tda, 1);
		addText(61614, "10% Damage Boost", 0x2070cc, false, true, 100, tda, 1);
		addText(61615, "(Only for Event)", 0x2070cc, false, true, 100, tda, 1);

		addText(61616, "Event bonuses:", 0xe8a430, false, true, 100, tda, 2);
		addText(61617, "5% Droprate bonus", 0xe8a430, false, true, 100, tda, 1);
		addText(61618, "15% Damage Boost", 0xe8a430, false, true, 100, tda, 1);
		addText(61619, "(Only for Event)", 0xe8a430, false, true, 100, tda, 1);

		addText(61620, "Event bonuses:", 0x32bf1c, false, true, 100, tda, 2);
		addText(61621, "20% Droprate bonus", 0x32bf1c, false, true, 100, tda, 1);
		addText(61622, "5% Damage Boost", 0x32bf1c, false, true, 100, tda, 1);
		addText(61623, "(Only for Event)", 0x32bf1c, false, true, 100, tda, 1);
		addButtonWSpriteLoader(61624, 737, "Close window");
	...
	public static void achievements(TextDrawingArea[] tda) {
		...
		addHoverButtonWSpriteLoader(id, 1018, 16, 16, "Close Window", 0, id + 1, 1);
		...
		addConfigButtonWSpriteLoader(id, 41750, 1025, 1026, 119, 21, "Easy", 0, 5, 1090);
		tab.child(c++, id++, 8 + x, 22 + y);
		addConfigButtonWSpriteLoader(id, 41750, 1025, 1026, 119, 19, "Medium", 1, 5, 1090);
		tab.child(c++, id++, 124 + x, 22 + y);
		addConfigButtonWSpriteLoader(id, 41750, 1025, 1026, 119, 19, "Hard", 2, 5, 1090);
		tab.child(c++, id++, 242 + x, 22 + y);
		addConfigButtonWSpriteLoader(id, 41750, 1025, 1026, 119, 19, "Elite", 3, 5, 1090);
	...
	public static void Pets(TextDrawingArea atextdrawingarea[]) {
		...
		addText(3210, "SebZero Point Shop", atextdrawingarea, 3, 0xffcc33, false, true);
		...
		addText(3276, "Kill ::vortexwarriors To Obtain SebZero Points!", atextdrawingarea, 3, 0xffcc33, false, true);
	...
	public static void GoldenScratchCardNew(TextDrawingArea[] tda) {
		...
		RSInterface.addText(39302, "SebZero Scratch Card", tda, 2, 0xFF9900, true, true); // 20014
	...
	private static void instanceInterface(TextDrawingArea[] tda) {
		...
		addHoverButtonWSpriteLoader(58954, 1095, 147, 32, "Teleport", -1, 58955, 1);
		addHoveredImageWSpriteLoader(58955, 1096, 147, 32, 58956);

		addHoverButtonWSpriteLoader(58958, 1095, 147, 32, "Choose Time", -1, 58959, 1);
	...
	private static void printFreeIdRange(int minimumFreeSlotsAvailable) {
		for (int i = 0; i < 85000; i++) {
			int freeSlots = 0;
			while (85000 > (i + 1) && interfaceCache[i++] == null)
				freeSlots++;
	...
	private static void combiner(TextDrawingArea[] tda) {
		...
		addToItemGroup(19710, 1, 4, 0, 23, true, new String[] {null, null, null, null, null}); // int id, int w, int h, int x, int y, boolean hasActions, String[] actions
	...
	public static void teleportInterface(TextDrawingArea[] tda) {
		...
		addText(50509, "@whi@Preview", 0xFF9900, true, true, 100, tda, 2);
		addText(50510, "@whi@Description", 0xFF9900, true, true, 100, tda, 2);
		addText(50511, "@whi@Drops", 0xFF9900, true, true, 100, tda, 2);
		...
		for (int bossText = 50601; bossText < 50700; bossText++) {
			addClickableText(bossText, "", "Select", fonts, 1, 0xFF9900, 130, 13);
	...
	public static void gamblingInterface(TextDrawingArea[] tda) {
		...
		addText(57192, "Flower poker", ColorConstants.RS_ORANGE, false, true, 52, tda, 0);
		addText(57193, "Dice Duel(ft3)", ColorConstants.RS_ORANGE, false, true, 52, tda, 0);

		addToggleButton1(57194, 1077, 1702, 119, 15, "Blackjack");
		addText(57195, "Blackjack (playername hosts)", ColorConstants.RS_ORANGE, false, true, 52, tda, 0);
		addToggleButton1(57196, 1077, 1703, 119, 15, "55x2");
		addText(57197, "55x2 (playername hosts)", ColorConstants.RS_ORANGE, false, true, 52, tda, 0);

		addText(57198, "NOTE: Who hosts depends on who accepts first", ColorConstants.ORANGE, false, true, 52, tda, 0);
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "SebZero Account Setup", 0xff9933, true, true, 52, tda, 3);
		addText(52753, "Beginner Items:", 0xff9933, false, true, 52, tda, 1);
		...
		addConfigButtonWSpriteLoader(52773, 51750, 937, 938, 15, 15, "Select Custom Ironman", 3, 5, 1085);
		...
		addText(52774, "  Custom Iron", 0xff9933, false, true, 52, tda, 0);
		addText(52764, "Play SebZero as an Iron man.", 0xff9933, true, true, 52, tda, 0);
		...
		addHoverButtonWSpriteLoader(52769, 961, 123, 30, "Confirm selection", -1, 52770, 1);
		addHoveredImageWSpriteLoader(52770, 962, 123, 30, 52771);
		...
		tab.child(18, 52769, 364, 216);
		tab.child(19, 52770, 364, 216);
		tab.child(20, 52772, 423, 220);
		tab.child(21, 52773, 366, 187);
		tab.child(22, 52774, 395, 189);
		tab.child(23, 52775, 388, 187);
		/**
		 * First row of items
		 */
		int child = 24;
	...
	public static void donationDeals(TextDrawingArea[] tda) {
		...
		addText(57278, "$50", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addText(57279, "$200", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addText(57280, "$350", ColorConstants.ORANGE, false, true, 52, tda, 0);
	...
	public static void dailyRewards(TextDrawingArea[] tda) {
		...
		addSpriteLoader(57211, 1079);

		addSpriteLoader(57212, 1080);
		addSpriteLoader(57213, 1080);
		addSpriteLoader(57214, 1080);
		addSpriteLoader(57215, 1080);
		addSpriteLoader(57216, 1080);
		addSpriteLoader(57217, 1080);
		addText(57218, "Reedem a vote scroll to\\nget a vote reward", 0xff9933, false, true, 52, tda, 1);
		addSpriteLoader(57219, 1081);
	...
	public static void Starter(TextDrawingArea[] tda) {
		...
		addText(51753, "Beginner Items:", 0xff9933, false, true, 52, tda, 1);
	...
	public static void TeleTAB1() {
		...
		addText(50430, "SebZero Teleports", fonts, 2, 0xff9040, true, true); // rename it whatever
	...
	public static void TeleTAB2() {
		...
		addText(50430, "SebZero Teleports", fonts, 2, 0xff9040, true, true);
	...
	public static void playersOnline(TextDrawingArea[] tda) {
		...
		addText(57007, "SebZero", 0xff9933, true, true, -1, tda, 0);
	...
	public static void clanswarsOptions(TextDrawingArea[] tda) {
		...
		addText(28562, "Clan wars options: Challenging someone", tda, 0, 0xFFFAFA, true, true);
	...
	public static void clanswarsGame(TextDrawingArea[] tda) {
		...
		addText(28550, "1", tda, 0, 0xFFFAFA, true, true);
		addText(28551, "1", tda, 0, 0xFFFAFA, true, true);
		addText(28552, "Countdown to battle:", tda, 0, 0xB17A37, true, true);
		addText(28553, "0m 10s", tda, 0, 0xFFFAFA, true, true);
    ...
    private static void decode(final Stream stream, TextDrawingArea textDrawingAreas[],
                               CacheArchive streamLoader_1) {
	    decode(stream, textDrawingAreas, streamLoader_1, false);
    }

	private static void decode(final Stream stream, TextDrawingArea textDrawingAreas[],
                               CacheArchive streamLoader_1, final boolean custom) {
        int parentId = -1;
        ...
        while (stream.currentOffset < stream.buffer.length) {
            ...
            if (custom) {
                rsInterface.interfaceShown = stream.readByte() == 1;
            }
            ...
            if (rsInterface.type == 4) {
                rsInterface.message = stream.readString().replaceAll("RuneScape", "SebZero");
                if (rsInterface.message.toLowerCase().equals("the bank of SebZero")) {
                    rsInterface.message = "        The Bank of SebZero";
                }
	...
	public static void unpack(CacheArchive streamLoader, TextDrawingArea textDrawingAreas[],
		...
		spriteArchive = streamLoader_1;
		Stream stream = new Stream(streamLoader.getDataForName("data"));
		decode(stream, textDrawingAreas, streamLoader_1);
		try {
            final File dir = Paths.get(signlink.findcachedir() + "/data/if1/").toFile();
            final File[] directoryListing = dir.listFiles();
            if (directoryListing != null) {
                for (File child : directoryListing) {

                    Stream s = new Stream(Files.readAllBytes(child.toPath()));
                    if (child.getName().split("\\.")[1].equalsIgnoreCase("if1c")) {
                        decode(s, textDrawingAreas, streamLoader_1, true);
                    } else {
                        decode(s, textDrawingAreas, streamLoader_1);
                    }
                }
            }
        ...
        raidRewardInterface(textDrawingAreas);
        raidInterface(textDrawingAreas);
		...
		drawChatBoxOverlay(textDrawingAreas);
		dungeonInfo();
		...
		newTeleport(textDrawingAreas);
		dropChecker(textDrawingAreas);
		...
		lootingBagBank(textDrawingAreas);
		refferal(textDrawingAreas);
		perkTree(textDrawingAreas);
		goodiebagInterface(textDrawingAreas);
		upgradeInt(textDrawingAreas);
		wellOfGoodwill(textDrawingAreas);
		TeleTAB4();
		TeleTAB5();
		...
		forgingInterface(textDrawingAreas);
		...
		DonatorInterface.newDonatorScreen(textDrawingAreas);
		npcTasksInterface(textDrawingAreas);
		xmasOptionInterface(textDrawingAreas);
	//	statsComparatorInterface(textDrawingAreas);
		...
		playerPanelInterface(textDrawingAreas);
		...
		mysteryBoxViewerOwner(textDrawingAreas);//mysteryBoxViewerOwner
		mysteryBoxViewer(textDrawingAreas);//mysteryBoxViewer
		mysteryBox(textDrawingAreas);//mysteryBoxViewerOwner
		...
		itemHoverInterface(textDrawingAreas);
		
		override(textDrawingAreas);
		search(textDrawingAreas);
		
		groups(textDrawingAreas);
		groupStorage(textDrawingAreas);
		setupWithActions();
		
		starterIntrace(textDrawingAreas);

		raidLobby();
		raidOverlay();
		raidRewards();

        salvageInterface(textDrawingAreas);
        wheelOfFortune(textDrawingAreas);
        squealOfFortuneTab(textDrawingAreas);
        bestInSlot();
        boxSpinner();
        Motivational_Message.motivationalMessage();
        Event_chest.eventChestInterface(textDrawingAreas);
        NewEquipmentScreen.newEquipmentScreen(textDrawingAreas);
        Mini_me.miniMeInterface(textDrawingAreas);
        PlayerPanel.playerPanelInterface(textDrawingAreas);
        SettingsInterface.load();

      //  printEmptyInterfaces();
		//spriteCache = null;
	}

    private static void boxSpinner() {
        final int STARTING_POINT = 32024;
        RSInterface main = addInterface(STARTING_POINT);
        addSpriteLoader(STARTING_POINT + 1, 1212);
        addText(STARTING_POINT + 2, "Common Rewards", fonts, 0, 0xff8624, true, true);
        addText(STARTING_POINT + 3, "Uncommon Rewards", fonts, 0, 0xff8624, true, true);
        addText(STARTING_POINT + 4, "Rare Rewards", fonts, 0, 0xff8624, true, true);

        addText(STARTING_POINT + 14, "Mystery Box Interface", fonts, 1, ColorConstants.YELLOW, true, true);
        main.totalChildren(12);
        main.child(0, STARTING_POINT + 1, 10, 10);
        main.child(1, STARTING_POINT + 20, 5, 151);
        main.child(2, STARTING_POINT + 30, 162, 151);
        main.child(3, STARTING_POINT + 40, 322, 151);
        main.child(4, STARTING_POINT + 2, 90, 132);
        main.child(5, STARTING_POINT + 3, 250, 132);
        main.child(6, STARTING_POINT + 4, 410, 132);
        main.child(7, STARTING_POINT + 14, 263, 19);
        main.child(8, STARTING_POINT + 60, 17, 0);
        addHoverableSprite(STARTING_POINT + 10, 1213, 1214, true, "Spin");
        main.child(9, STARTING_POINT + 10, 211, 97);
        addTextComponent(STARTING_POINT + 11, "Spin", fonts, 2, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(10, STARTING_POINT + 11, 242, 100);
        addSpriteLoader(STARTING_POINT + 12, 1012);
        main.child(11, STARTING_POINT + 12, 259, 49);
        RSInterface boxes = addInterface(STARTING_POINT + 60);
        boxes.width = 474;
        boxes.totalChildren(52);

        addSpriteLoader(STARTING_POINT + 61, 1215);
        boxes.child(0, STARTING_POINT + 61, 0, 47);

        int x = 0;
        for (int i = 0; i < 50; i++) {
            addSpriteLoader(STARTING_POINT + 62 + i, 1216);
            boxes.child(1 + i, STARTING_POINT + 62 + i, x, 49);
            x += 2880;
        }

        addToItemGroup(STARTING_POINT + 115, 64 * 50, 1, 13, 0, false, null);
        boxes.child(51, STARTING_POINT + 115, 7, 55);

        RSInterface commonScroll = addInterface(STARTING_POINT + 20);
        commonScroll.width = 150;
        commonScroll.height = 144;
        commonScroll.scrollMax = 1000;
        addToItemGroup(STARTING_POINT + 21, 3, 100, 16, 4, true, new String[]{null, null, null, null, null});
        commonScroll.totalChildren(1);
        commonScroll.child(0, STARTING_POINT + 21, 18, 3);
        RSInterface mediumScroll = addInterface(STARTING_POINT + 30);
        mediumScroll.width = 150;
        mediumScroll.height = 144;
        mediumScroll.scrollMax = 1000;
        mediumScroll.totalChildren(1);
        mediumScroll.child(0, STARTING_POINT + 31, 18, 3);
        addToItemGroup(STARTING_POINT + 31, 3, 50, 16, 4, true, new String[]{null, null, null, null, null});
        RSInterface rareScroll = addInterface(STARTING_POINT + 40);
        rareScroll.width = 150;
        rareScroll.height = 144;
        rareScroll.scrollMax = 1000;
        rareScroll.totalChildren(1);
        rareScroll.child(0, STARTING_POINT + 41, 18, 3);
        addToItemGroup(STARTING_POINT + 41, 3, 50, 16, 4, true, new String[]{null, null, null, null, null});
    }
    ...
    public static void printEmptyInterfaces() {
        ...
        for (int i = 0; i < 100000; i++) {
            RSInterface widget = interfaceCache[i];
            if (widget == null) {
                if (firstNull == -1) {
                    firstNull = i;
                }
	...
	public static void playerOwnedShopInterface(TextDrawingArea[] tda) {
		...
		addConfigButton(32602, 32603, 3, 4, dir, 164, 22, "Search", 1, 0, 968);
		interfaceCache[32602].disableRendering = true;
		
		addHoverButton(32606, dir, 1, 16, 16, "Close Window", 250, 32607, 3);
		addHoveredButton(32607, dir, 2, 16, 16, 32608);
		
		addText(32610, "Player Owned Shops", tda, 2, 16750623, true, true);
		
		addText(32611, "Search", tda, 0, 16750623, false, true);

		addHover(54098, 1, 0, 54099, 5, dir, 121, 25, "My Shop");
		addHovered(54099, 6, dir, 121, 25, 54100);
		
		addText(54101, "My Shop", tda, 0, 16750623, false, true);

		addHover(54102, 1, 0, 54103, 5, dir, 121, 25, "Search Player");
		addHovered(54103, 6, dir, 121, 25, 54104);
		
		addText(54105, "Player Shops", tda, 2, 16750623, false, true);

		int x = 10, y = 10;
		tab.totalChildren(14);
		tab.child(0, 32601, 43, 14);
		tab.child(1, 32602, 87 + x, 273 + y);
		// tab.child(2, 32604, 360+x, 273+y);
		tab.child(2, 32606, 442, 24);
		tab.child(3, 32607, 442, 24);
		// tab.child(6, 32612, 363+x, 276+y);
		tab.child(4, 32620, 189, 54);
		tab.child(5, 32622, 54, 133);
		tab.child(6, 32610, 242 + x, 13 + y);
		tab.child(7, 54098, 58, 85);
		tab.child(8, 54099, 58, 85);
		tab.child(9, 54101, 90, 92);
		tab.child(10, 54102, 58, 57);
		tab.child(11, 54103, 58, 57);
		tab.child(12, 32611, 90, 64);
		tab.child(13, 54105, 75, 115);
		tab2.width = 251;
		tab2.height = 254;
		tab2.scrollMax = 3000;
		itemGroup(32621, 6, 9, 10, 10);
		tab2.totalChildren(1);
		tab2.child(0, 32621, 7, 14);
		for (int i = 0; i < 100; i++) {
			addClickableText(32623 + i, "  " + i, "Select", tda, 1, 0xeb981f, false, true, 110, 20);
		}
		tab3.width = 112;
		tab3.height = 175;
		...
		for (int i = 0; i < 100; i++) {
			tab3.child(i, 32623 + i, 1, 0 + (i * 20));
			interfaceCache[32623 + i].xAdjust = 5;
			interfaceCache[32623 + i].yAdjust = 2;
		}
	}
    ...
    public static void salvageInterface(TextDrawingArea[] font) {
        String dir = "Interfaces/Salvage/SPRITE";
        int STARTING_POINT = 18303;
        int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);

        main.totalChildren(19);

        int childId = 0;
        addSprite(STARTING_POINT, 0, dir);
        main.child(childId++, STARTING_POINT++, 84, 40);

        addHoverButton(STARTING_POINT, dir, 1, 16, 16, "Close", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 402, 50);

        addHoveredButton(STARTING_POINT, dir, 2, 16, 16, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 402, 50);
        STARTING_POINT++;

        addText(STARTING_POINT, "Droprate Exchange", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 259, 50);

        addText(STARTING_POINT, "Here you can exchange @re1@salvage tokens@re4@ for @re2@extra drop rate@re4@.\\nYou can get a @re3@maximum@re4@ of @re2@extra 100% droprate@re4@.", font, 0, 0x8D8D8D, true, true);
        main.child(childId++, STARTING_POINT++, 259, 86);

        addText(STARTING_POINT, "Description", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 327, 130);

        addHoverButtonConfig(STARTING_POINT, dir, 3, 140, 31, "Exchange", 0, STARTING_POINT + 1, 1, 1234, 1);
        main.child(childId++, STARTING_POINT++, 95, 125);

        addHoveredButton(STARTING_POINT, dir, 4, 140, 31, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 95, 125);
        STARTING_POINT++;

        addText(STARTING_POINT, "300 Salvage", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 160, 135);

        addHoverButtonConfig(STARTING_POINT, dir, 3, 140, 31, "Exchange", 0, STARTING_POINT + 1, 1, 1234, 2);
        main.child(childId++, STARTING_POINT++, 95, 162);

        addHoveredButton(STARTING_POINT, dir, 4, 140, 31, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 95, 162);
        STARTING_POINT++;

        addText(STARTING_POINT, "1000 Salvage", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 160, 172);

        addHoverButtonConfig(STARTING_POINT, dir, 3, 140, 31, "Exchange", 0, STARTING_POINT + 1, 1, 1234, 3);
        main.child(childId++, STARTING_POINT++, 95, 199);

        addHoveredButton(STARTING_POINT, dir, 4, 140, 31, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 95, 199);
        STARTING_POINT++;

        addText(STARTING_POINT, "2500 Salvage", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 160, 209);

        addHoverButton(STARTING_POINT, dir, 6, 140, 31, "Exchange", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 121, 246);

        addHoveredButton(STARTING_POINT, dir, 7, 140, 31, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 121, 246);
        STARTING_POINT++;

        addText(STARTING_POINT, "Exchange", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 166, 253);

        int layer = STARTING_POINT++;
        RSInterface information = addInterface(layer);
        information.width = 159;
        information.height = 132;
        information.scrollMax = 133;

        information.totalChildren(1);

        int informationChildId = 0;

        //addSprite(STARTING_POINT, 1, dir);
       // System.out.println("info text id: " + STARTING_POINT);
        addText(STARTING_POINT, "Lorem ipsum dolor sit amet,\\nconsectetur adipiscing elit.", font, 0, 0x8D8D8D, false, true);
        information.child(informationChildId++, STARTING_POINT++, 0, 0);

        main.child(childId++, layer, 241, 149);
    }
	
	public static void starterIntrace(TextDrawingArea[] font) {
		String dir = "Interfaces/Groups/Modes/SPRITE";
	    int STARTING_POINT = 19301;
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);

		String[] modes = { "Normal ", "<img=33> Ironman", "<img=32> Ultimate Ironman", "<img=999> Group Ironman" };
        main.totalChildren(9 + (modes.length * 3));

		int childId = 0;
        addSprite(STARTING_POINT, 0, dir);
        main.child(childId++, STARTING_POINT++, 22, 8);
        
		addHoverButton(STARTING_POINT, dir, 1, 118, 28, "Confirm", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 345, 247);

		addHoveredButton(STARTING_POINT, dir, 2, 118, 28, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 345, 247);
        STARTING_POINT++;

		addText(STARTING_POINT, "SebZero game mode selection screen", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 259, 11);

		addText(STARTING_POINT, "Select a game mode", font, 1, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 118, 38);

		addText(STARTING_POINT, "Mode Description", font, 1, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 345, 38);

     //   System.out.println("desc id: " + STARTING_POINT);
		addText(STARTING_POINT, "In this game mode\\nPlay the game without any restrictions.\\n0.0% Droprate bonus", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 340, 59);

		addText(STARTING_POINT, "Starter Pack", font, 1, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 184, 212);

		addItemOnInterface(STARTING_POINT, mainId, 9, 2, 0, 5, new String[] { null });
		
		//System.out.println("gamemode screen id container: " + STARTING_POINT);
		
		for(int i = 0; i < 18; i++) {
			interfaceCache[STARTING_POINT].inv[i] = 4151 + i;
			interfaceCache[STARTING_POINT].invStackSizes[i] = 1;
		}
		
		main.child(childId++, STARTING_POINT++, 36, 238);
		
		for(int i = 0, y = 0; i < modes.length; i++, y += 29) {
			addButton(STARTING_POINT, 3, dir, "Select " + modes[i], 171, 29);
	        main.child(childId++, STARTING_POINT++, 34, 57 + y);
			
			addConfigButton(STARTING_POINT, mainId, 4, 5, 15, 15, new String[] { "" }, i, 0, 1676, dir);
			main.child(childId++, STARTING_POINT++, 42, 64 + y);

			addText(STARTING_POINT, modes[i], font, 2, 16750623, false, true);
	        main.child(childId++, STARTING_POINT++, 65, 64 + y);
		}
	}
	
	public static void groups(TextDrawingArea[] font) {
		String dir = "Interfaces/Groups/SPRITE";
	    int STARTING_POINT = 62252;
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);
		...
		int childId = 0;
        addSprite(STARTING_POINT, 0, dir);
        main.child(childId++, STARTING_POINT++, 60, 7);
        
		addHoverButton(STARTING_POINT, dir, 1, 21, 21, "Close", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 423, 14);

		addHoveredButton(STARTING_POINT, dir, 2, 21, 21, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 423, 14);
        STARTING_POINT++;

		addText(STARTING_POINT, "Iron Man Groups", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 259, 17);

		addText(STARTING_POINT, "Owner", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 108, 49);

		addText(STARTING_POINT, "Online", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 182, 49);

		addText(STARTING_POINT, "Group\\nsize", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 248, 43);

		addText(STARTING_POINT, "Public", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 311, 49);

		addText(STARTING_POINT, "Code", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 385, 49);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 379, 1);
        main.child(childId++, STARTING_POINT++, 66, 66);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 24);
        main.child(childId++, STARTING_POINT++, 151, 42);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 24);
        main.child(childId++, STARTING_POINT++, 214, 42);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 24);
        main.child(childId++, STARTING_POINT++, 279, 42);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 24);
        main.child(childId++, STARTING_POINT++, 343, 42);
        
		addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 24);
        main.child(childId++, STARTING_POINT++, 429, 42);
        
        int layer = STARTING_POINT++;
       // System.out.println("LAYER stuff: " + layer);
        RSInterface entries = addInterface(layer);
		int maxGroups = 50;
        entries.width = 363;
        entries.height = 254;
		entries.scrollMax = maxGroups * 30;
		
		entries.totalChildren(maxGroups * 10);
        
		int entriesChildId = 0;
		
		for(int index = 0, x = 0, y = 0; index < maxGroups; index++, y += 30) {
	        
			addRectangle(STARTING_POINT, 0, index % 2 == 0 ? 0x524B40 : 0x42382E, true, 363, 30);
			entries.child(entriesChildId++, STARTING_POINT++, x, y);
	        
			addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 30);
			entries.child(entriesChildId++, STARTING_POINT++, x + 85, y + 0);
	        
			addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 30);
			entries.child(entriesChildId++, STARTING_POINT++, x + 148, y + 0);
	        
			addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 30);
			entries.child(entriesChildId++, STARTING_POINT++, x + 213, y + 0);
	        
			addRectangle(STARTING_POINT, 0, 0x000000, false, 1, 30);
			entries.child(entriesChildId++, STARTING_POINT++, x + 277, y + 0);

			addText(STARTING_POINT, "Mobjunk (" + STARTING_POINT + ")", font, 0, 16750623, true, true);
			entries.child(entriesChildId++, STARTING_POINT++, x + 42, y + 10);
			
			addConfigButton(STARTING_POINT, layer, 3, 4, 16, 16, new String[] { "" }, 1, 0, 1666 + index, dir);
			entries.child(entriesChildId++, STARTING_POINT++, x + 109, y + 7);

			addText(STARTING_POINT, "0 (" + STARTING_POINT + ")", font, 0, 16750623, true, true);
			entries.child(entriesChildId++, STARTING_POINT++, x + 180, y + 10);
			
			addConfigButton(STARTING_POINT, layer, 5, 6, 16, 20, new String[] { "" }, 1, 0, 1766 + index, dir);
			entries.child(entriesChildId++, STARTING_POINT++, x + 237, y + 5);

			addText(STARTING_POINT, "123 (" + STARTING_POINT + ")", font, 0, 16750623, true, true);
			entries.child(entriesChildId++, STARTING_POINT++, x + 320, y + 10);
	        
		}
		
		//System.out.println("STARTING_POINT: " + STARTING_POINT);
		
        main.child(childId++, layer, 66, 67);
	}
	
	public static void groupStorage(TextDrawingArea[] font) {
		String dir = "Interfaces/Groups/Storage/SPRITE";
	    int STARTING_POINT = 72080; //72080
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(15264);

        main.totalChildren(29);

		int childId = 0;
        addSprite(STARTING_POINT, 0, dir);
        main.child(childId++, STARTING_POINT++, 12, 43);
        
		addHoverButton(STARTING_POINT, dir, 1, 21, 21, "Close", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 472, 50);
        ...
        //System.out.println("STARTING_POINT: " + STARTING_POINT);
		addText(STARTING_POINT, "Group Storage", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 254, 53);

		addText(15266, "0", font, 0, 16750623, true, true);
        main.child(childId++, 15266, 31, 49);

		addText(STARTING_POINT, "100", font, 0, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 31, 61);
        
        /**
         * Place Holder
         */
		addConfigButton(STARTING_POINT, mainId, 4, 3, 36, 36, new String[] { "" }, 0, 0, 111, dir);
		main.child(childId++, STARTING_POINT++, 343, 248);
        
		addHoverButton(STARTING_POINT, dir, 5, 36, 36, "Enable Always set placeholders", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 343, 248);

		addHoveredButton(STARTING_POINT, dir, 6, 36, 36, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 343, 248);
        STARTING_POINT++;
         ...
         * Search
         */
		addConfigButton(STARTING_POINT, mainId, 4, 3, 36, 36, new String[] { "" }, 0, 0, 363, dir);
		main.child(childId++, STARTING_POINT++, 381, 248);
        
		addHoverButton(STARTING_POINT, dir, 7, 36, 36, "Search", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 381, 248);

		addHoveredButton(STARTING_POINT, dir, 8, 36, 36, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 381, 248);
        STARTING_POINT++;
         ...
         * Inventory
         */
		addConfigButton(STARTING_POINT, mainId, 4, 3, 36, 36, new String[] { "" }, 0, 0, 364, dir);
		main.child(childId++, STARTING_POINT++, 419, 248);
        
		addHoverButton(STARTING_POINT, dir, 9, 36, 36, "Deposit inventory", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 419, 248);

		addHoveredButton(STARTING_POINT, dir, 10, 36, 36, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 419, 248);
        STARTING_POINT++;
         ...
         * Equipment
         */
		addConfigButton(STARTING_POINT, mainId, 4, 3, 36, 36, new String[] { "" }, 0, 0, 365, dir);
		main.child(childId++, STARTING_POINT++, 458, 248);
        
		addHoverButton(STARTING_POINT, dir, 11, 36, 36, "Deposit worn items", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 458, 248);

		addHoveredButton(STARTING_POINT, dir, 12, 36, 36, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 458, 248);
        STARTING_POINT++;
         ...
         * Bottom left options
         */
		addText(STARTING_POINT, "Rearrange mode:", font, 1, 16750623, false, true);
		main.child(childId++, STARTING_POINT++, 19, 290 - 43);
		
		addConfigButton(STARTING_POINT, mainId, 13, 14, 50, 22, new String[] { "" }, 0, 0, 304, dir);
		main.child(childId++, STARTING_POINT++, 17, 305 - 43);
		
		addClickableText(STARTING_POINT, "Swap", "Select", fonts, 1, 16750623, 50, 22, true, true, 0, 3);
		main.child(childId++, STARTING_POINT++, 17, 305 - 43);
		
		addConfigButton(STARTING_POINT, mainId, 13, 14, 50, 22, new String[] { "" }, 1, 0, 304, dir);
		main.child(childId++, STARTING_POINT++, 67, 305 - 43);
		
		addClickableText(STARTING_POINT, "Insert", "Select", fonts, 1, 16750623, 50, 22, true, true, 0, 3);
		main.child(childId++, STARTING_POINT++, 67, 305 - 43);

		addText(STARTING_POINT, "Withdraw as:", font, 1, 16750623, false, true);
		main.child(childId++, STARTING_POINT++, 132, 290 - 43);
		
		addConfigButton(STARTING_POINT, mainId, 13, 14, 50, 22, new String[] { "" }, 0, 0, 115, dir);
		main.child(childId++, STARTING_POINT++, 117, 305 - 43);
		
		addClickableText(STARTING_POINT, "Item", "Select", fonts, 1, 16750623, 50, 22, true, true, 0, 3);
		main.child(childId++, STARTING_POINT++, 117, 305 - 43);
		
		addConfigButton(STARTING_POINT, mainId, 13, 14, 50, 22, new String[] { "" }, 1, 0, 115, dir);
		main.child(childId++, STARTING_POINT++, 167, 305 - 43);
		
		addClickableText(STARTING_POINT, "Note", "Select", fonts, 1, 16750623, 50, 22, true, true, 0, 3);
		main.child(childId++, STARTING_POINT++, 167, 305 - 43);
        
        int itemLayerId = STARTING_POINT++;
        RSInterface itemLayer = addInterface(itemLayerId);
        itemLayer.width = 460;
        itemLayer.height = 168;
        itemLayer.scrollMax = 420;

        itemLayer.totalChildren(1);
        
		int layerChildId = 0;

		addItemOnInterface(15265, itemLayerId, 10, 10, 10, 10, new String[] { "Withdraw-1", "Withdraw-5", "Withdraw-10", "Withdraw-All", "Withdraw-X" });
		itemLayer.child(layerChildId++, 15265, 26, 5);


        main.child(childId++, itemLayerId, 18, 78);
	}
	
	public static void setupWithActions() {
	    int STARTING_POINT = 6639;
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);
		...
		addItemOnInterface(STARTING_POINT, mainId, 4, 7, 10, 4, new String[] { "Deposit-1", "Deposit-5", "Deposit-10", "Deposit-All", "Deposit-X" });
		main.child(childId++, STARTING_POINT++, 16, 8);
	}
	
	public static void override(TextDrawingArea[] font) {
		String dir = "Interfaces/Override/SPRITE";
	    int STARTING_POINT = 2360;
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);
		...
		int childId = 0;
        addSprite(STARTING_POINT, 2, dir);
        main.child(childId++, STARTING_POINT++, 105, 0);
        
		addHoverButton(STARTING_POINT, dir, 0, 16, 16, "Close", 0, STARTING_POINT + 1, 1);
        main.child(childId++, STARTING_POINT++, 381, 9);

		addHoveredButton(STARTING_POINT, dir, 1, 16, 16, STARTING_POINT + 1);
        main.child(childId++, STARTING_POINT++, 381, 9);
        STARTING_POINT++;

		addText(STARTING_POINT, "Appearance Customization", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 254, 10);
		
		addChar(STARTING_POINT); //130, 215
        main.child(childId++, STARTING_POINT++, 105, 215);
        
		int[][] position = { { 318, 35 }, { 276, 74 }, { 318, 74 }, { 360, 74 }, { 276, 113 }, { 318, 113 }, { 360, 113 }, { 318, 151 }, { 276, 191 }, { 318, 191 }, { 360, 191 } };

		
		for(int index = 0; index < position.length; index++) {
			addConfigButton(STARTING_POINT, mainId, 4 + index, 3, 36, 36, new String[] { "Select", "Reset" }, 1, 9, 1111 + index, dir);
	        main.child(childId++, STARTING_POINT++, position[index][0], position[index][1]);

			addItemOnInterface(STARTING_POINT, mainId, new String[] { null });
	        main.child(childId++, STARTING_POINT++, position[index][0] + 2, position[index][1] + 2);
			
		}

		addText(STARTING_POINT, "My presets", font, 2, 16750623, true, true);
        main.child(childId++, STARTING_POINT++, 337, 227);

        addSprite(STARTING_POINT, 15, dir);
        main.child(childId++, STARTING_POINT++, 276, 245);
        
        int layer = STARTING_POINT++;
        RSInterface presets = addInterface(layer);
		presets.width = 108;
		presets.height = 70;
		int maxPresets = 5;
		int presetChildId = 0;
		
		presets.totalChildren(maxPresets);
        
		for(int index = 0, y = 2; index < maxPresets; index++, y += 14) {
			addClickableText(STARTING_POINT, "", "Preset " + (index + 1), fonts, 0, 16750623, 108, 12, true, true);
			
			interfaceCache[STARTING_POINT].tooltips = new String[] { "Load " + ("Preset " + (index + 1)), "Save " + ("Preset " + (index + 1)), "Rename " + ("Preset " + (index + 1)) };
			interfaceCache[STARTING_POINT].atActionType = 9;
			
			presets.child(presetChildId++, STARTING_POINT++, 0, y);
		}
        
        main.child(childId++, layer, 282, 251);
        
        
      		addConfigButton(STARTING_POINT, mainId, 16, 3, 36, 36, new String[] { "Select", "Reset" }, 1, 9, 1122, dir);
              main.child(childId++, STARTING_POINT++, 276, 35);
              //System.out.println("STARTING_POINT (aura slot): " + STARTING_POINT);
      		addItemOnInterface(STARTING_POINT, mainId, new String[] { null });
              main.child(childId++, STARTING_POINT++, 276 + 2, 35 + 2);
	}
	
	public static void search(TextDrawingArea[] font) {
	    int STARTING_POINT = 33400;
	    int mainId = STARTING_POINT++;
        RSInterface main = addInterface(mainId);
		int childId = 0;
		...
		addRectangle(STARTING_POINT, 0, 0x463214, false, 505, 129);
        main.child(childId++, STARTING_POINT++, 0, 3);
        
		addRectangle(STARTING_POINT, 0, 0x564730, false, 503, 127);
        main.child(childId++, STARTING_POINT++, 1, 4);
        
		addRectangle(STARTING_POINT, 0, 0xAE9C7C, true, 501, 125);
        main.child(childId++, STARTING_POINT++, 2, 5);
        
        int layer = STARTING_POINT++;
        RSInterface item_layer = addInterface(layer);
		item_layer.width = 485;
		item_layer.height = 125;
		
		int total_results = 50;
		
		int total_rows = (total_results / 3);
		if(total_results % 3 != 0)
			total_rows++;
		
		int scrollMax = 125;
		if(total_rows > 3)
			scrollMax = total_rows * 32;
		
		item_layer.scrollMax = scrollMax;
		int layerChildId = 0;

		item_layer.totalChildren((total_results * 2) + 1);

      //  System.out.println("STARTING_POINT(box): " + STARTING_POINT);
		for(int index = 0, x = 1, y = 0; index < total_results; index++, x += 161) {
			if(index % 3 == 0 && index > 0) {
				x = 1;
				y += 32;
			}
			addRectangleClickable(STARTING_POINT, 150, 0xAE9C7C, true, 161, 32);
			item_layer.child(layerChildId++, STARTING_POINT++, x, y);
			//component.hideLayer = true;
		}

		//System.out.println("STARTING_POINT(item container): " + STARTING_POINT);
		addItemOnInterface(STARTING_POINT, mainId, 3, 100, 130, 0, new String[] { null });
		item_layer.child(layerChildId++, STARTING_POINT++, 1, 0);

      //  System.out.println("STARTING_POINT(text): " + STARTING_POINT);
		for(int index = 0, x = 40, y = 10; index < total_results; index++, x += 161) {
			if(index % 3 == 0 && index > 0) {
				x = 40;
				y += 32;
			}
			addText(STARTING_POINT, "Item name", font, 1, 0x000000, false, false);
			item_layer.child(layerChildId++, STARTING_POINT++, x, y);
		}
		
        main.child(childId++, layer, 2, 5);
	}	
	...
	public static void forumsInterface(TextDrawingArea[] tda) {
		 ...
		 *
		 */
		scroll.addText(50300, "SebZero Rules", 0x09f3f7, true, true, 100, tda, 2);
	...
	public static void customTeleports(TextDrawingArea[] tda) {
		...
		addButtonWSpriteLoader(64532, 1045, "Vetion", 152, 35);
		addButtonWSpriteLoader(64535, 1045, "Skotizo", 152, 35);
		addButtonWSpriteLoader(64536, 1045, "Kbd", 152, 35);
		addButtonWSpriteLoader(64539, 1045, "Vennatis", 152, 35);

		addText(64533, "Custom Boss Teleports", fonts, 0, 0xff7600, true, true);
		addText(64534, "Vetion", fonts, 2, 0x15ea18, true, true);
	...
	public static void upgradeInterface(TextDrawingArea[] tda) {
        ...
        addButtonWSpriteLoader(84966, 1186, "Weapons upgrades");
        addButtonWSpriteLoader(84967, 1187, "Armor upgrades");
        addButtonWSpriteLoader(84968, 1188, "Misc upgrades");
		addButtonWSpriteLoader(62202, 1045, "Upgrade Item", 241, 30);
		addButtonWSpriteLoader(84969, 1045, "Upgrade All", 241, 30);
		tab.addText(62204, "Upgrading Interface", fonts, 2, 0xFFA500);
		tab.addText(62205, "Upgradeable Items", fonts, 2, 0xFFA500);
		tab.addText(62206, "Upgrade Item", fonts, 2, 0xFFA500);
		tab.addText(84970, "Upgrade all", fonts, 2, 0xFFA500);
		tab.addText(62203, "Tokens required: -", fonts, 2, 0xFFA500);
		...
		tab.child(13, 84969, 319, 251);
		tab.child(10, 84966, 45, 45);
		tab.child(11, 84967, 145, 45);
		tab.child(12, 84968, 245, 45);
		tab.child(2, 62203, 325, 85);
		tab.child(3, 62204, 215, 18);
		tab.child(4, 62205, 61, 86);
		tab.child(5, 62206, 345, 228);
		tab.child(14, 84970, 345, 258);
	...
	public static void achievementsInterface() {
		...
		addText(45024, "Medium Tasks", fonts, 2, 0xFF9900, false, true);
		addText(45041, "Hard Tasks", fonts, 2, 0xFF9900, false, true);
		addText(45058, "Elite Tasks", fonts, 2, 0xFF9900, false, true);
		addText(45067, "Coming Soon", fonts, 2, 0xFF9900, false, true);
	}
	...
	public static void addClickableText(int id, String text, String tooltip, TextDrawingArea tda[], int idx, int color,
			int width, int height, boolean center, boolean shadow) {
		RSInterface Tab = addTabInterface(id);
		Tab.parentID = id;
		Tab.id = id;
		Tab.type = 4;
	...
	private static void questTabInterfaceNew() {
		...
		addHoverButtonWSpriteLoader(26614, 965, 85, 20, "Collection log", -1, 26615, 1);
		addHoveredImageWSpriteLoader(26615, 964, 85, 20, 26616);
		addText(26618, "Collection Log", fonts, 0, 16750623, false, true);
		...
		addText(26629, "@or2@Seph Boss@gre@Home", fonts, 0, 16750623, false, true);
		addText(26628, "@or2@Mass Boss:@gre@Home", fonts, 0, 16750623, false, true);
		addText(26627, "@or2@World Boss:@gre@Home", fonts, 0, 16750623, false, true);
		addText(26630, "@or2@Frost Boss:@gre@Home", fonts, 0, 16750623, false, true);
	...
	public static void statistics1(final TextDrawingArea[] tda) {
		...
		addText(id + 3, "SebZero", 0xAF6A1B, false, true, 0, tda, 2);
	...
	private static void questTabInterface() {
		RSInterface tab = addTabInterface(639);
		RSInterface scroll = addTabInterface(15016);
		addText(39155, "@or2@      <img=459>SebZerops.com", fonts, 2, 16750623, false, true);
	...
	private static void newTabInterface() {
		...
		addText(58702, "SebZerops.com", fonts, 2, 16750623, false, true);
	...
	public static void trainingTeleports(TextDrawingArea[] tda) {
		...
		addText(60656, "Beginner", tda, 1, 0xF7FE2E, true, true);
		addText(60657, "Medium", tda, 1, 0xF7FE2E, true, true);
		addText(60658, "Hardened", tda, 1, 0xF7FE2E, true, true);
		addText(60659, "Expert", tda, 1, 0xF7FE2E, true, true);
		addText(60660, "Maniac", tda, 1, 0xF7FE2E, true, true);
		addText(60661, "Minigames", tda, 1, 0xF7FE2E, true, true);
	...
	private static void teleportWidget(TextDrawingArea[] tda) {
		...
		addText(49121, "1,000,000 Coins", tda, 3, 0xFFFAFA, true, true);

		addSpriteLoader(49122, 970);
		addText(49123, "Dangerous", tda, 3, 0xFFFAFA, true, true);

		addSpriteLoader(49124, 971);
		addText(49125, "Inside Wilderness", tda, 3, 0xFFFAFA, true, true);

		addText(49126, "King Black Dragon", tda, 2, 0xFFFAFA, true, true);

		addText(49127, "Teleport", tda, 3, 0xFFFAFA, true, true);
		...
		for (int i = 0; i < 50; i += 2) {
			...
			addText(49129 + i + 1, "King Black Dragon", tda, 1, 0xFFFAFA, true, true);
    ...
    public static void addChild(final int parentIndex, final int childIndex, final int x, final int y, final int index) {
        final RSInterface parent = interfaceCache[parentIndex];
    ...
    public static int getIndexOfChild(final int parent, final int child) {
        final RSInterface rsi = interfaceCache[parent];
    ...
    public static RSInterface createSprite(final int parentIndex, final int index, final String disabled, final String enabled) {
        final Sprite disabledSprite = fetchSprite(disabled);
        final Sprite enabledSprite = fetchSprite(enabled);
        final RSInterface sprite = interfaceCache[index] = new RSInterface();
        sprite.id = index;
        sprite.parentID = parentIndex;
        sprite.type = 5;
        sprite.width = disabledSprite.myWidth;
        sprite.height = disabledSprite.myHeight;
    ...
    public static void EquipmentTab(TextDrawingArea[] tda) {
        ...
        addButtonWSpriteLoader(27653, 853, "Open Keepsake Interface", 41, 40);
        ...
        final RSInterface auraTab = createSprite(tab.id, "miscgraphics,0", "miscgraphics,0");
        final RSInterface inventory = interfaceCache[1688];
        inventory.sprites[14] = fetchSprite("wornicons,12");
        inventory.spritesX[14] = -97;
        inventory.spritesY[14] = -197;
        addChild(tab.id, auraTab.id, 37, 4, getIndexOfChild(tab.id, inventory.id));
	...
	public static void Trade(TextDrawingArea[] TDA) {
		...
		addText(3417, "Trading With:", 0xFFFAFA, true, true, 52, TDA, 2);
		addText(3418, "Trader's Offer", 0xFFFAFA, false, true, 52, TDA, 1);
		addText(3419, "Your Offer", 0xFFFAFA, false, true, 52, TDA, 1);
		...
		addText(53505, "1 has\\n 28 free\\n inventory slots.", 0xFFFAFA, true, true, -1, TDA, 0);
	...
	public static void addScroll(int ID, int r1, int ra1, int r2, int lvl, String name, TextDrawingArea[] TDA,
		...
		addText(ID + 3, "Level " + (lvl) + ": " + name, 0xFFFAFA, true, true, 52, 1);
	...
	public static void curseTab(TextDrawingArea[] TDA) {
		...
		int index = 0;
		addText(687, "99/99", 0xFFFAFA, false, false, -1, TDA, 1);
...
return tab;
	...
	public static void addButtonHDWSpriteLoader(int id, int sprite, String tooltip, int w, int h) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;
		tab.parentID = id;
		tab.type = 5;
	...
	public static void addConfigButton(int ID, int pID, int bID, int bID2, int width, int height, String[] tT,
			int configID, int aT, int configFrame, String spriteName) {
		RSInterface Tab = addTabInterface(ID);
		Tab.parentID = pID;
		Tab.id = ID;
		Tab.type = 5;
		...
		Tab.valueIndexArray[0][1] = configFrame;
		Tab.valueIndexArray[0][2] = 0;
		Tab.disabledSprite = imageLoader(bID, spriteName);
		Tab.enabledSprite = imageLoader(bID2, spriteName);
		//Tab.disabledSpriteId = bID;
		//Tab.enabledSpriteId = bID2;
		Tab.tooltips = tT;
	}
    ...
    public static void addHoverButtonConfig(int i, String imageName, int j, int width, int height, String text, int contentType, int hoverOver, int aT, int configID, int configFrame) {// hoverable
        // button
        RSInterface tab = addTabInterface(i);
        tab.id = i;
        tab.parentID = i;
	...
	public static void addLunar2RunesSmallBox(int ID, int r1, int r2, int ra1, int ra2, int rune1, int lvl, String name,
		...
		setBounds(ID + 2, 0, 0, 0, hover);
		addText(ID + 3, "Level " + (lvl + 1) + ": " + name, 0xFFFAFA, true, true, 52, 1);
		setBounds(ID + 3, 90, 4, 1, hover);
	...
	static Sprite getSprite(int spriteId, CacheArchive streamLoader, String spriteName) {
	...
	public static void addCharNew(int ID) {
		RSInterface t = interfaceCache[ID] = new RSInterface();
		t.id = ID;
		t.parentID = ID;
		t.type = 6;
	...
	private static void skillTabInterface() {
		...
		addSpriteLoaderButtonWithTooltipBox(31146, 246, "View @or2@Archeology @lre@Options", 268, 31147,
				"Archeology: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
	...
	public static void addItemOnInterface(int childId, int interfaceId, int width, int height, int x, int y, String[] options) {
		int size = width * height;
		if(childId == 4388) System.out.println("size: " + size);
		RSInterface rsi = interfaceCache[childId] = new RSInterface();
		rsi.actions = new String[10];
		rsi.spritesX = new int[20];
		
		rsi.inv = new int[size];
		rsi.invStackSizes = new int[size];
	...
	private static void tradeInterface() {
		...
		addText(3417, "Trading With:", 0xFFFAFA, true, true, 52, fonts, 2);
		addText(3418, "Trader's Offer", 0xFFFAFA, false, true, 52, fonts, 1);
		addText(3419, "Your Offer", 0xFFFAFA, false, true, 52, fonts, 1);
		...
		addText(12504, "Wealth transfer: 2147,000,000 coins' worth to Zezimablud12", 0xB9B855, true, true, -1, fonts,
				0);
		addText(12505, "1 has\\n 28 free\\n inventory slots.", 0xFFFAFA, true, true, -1, fonts, 0);
		...
		addText(3452, "Loan:", 0xFFFAFA, false, true, 52, fonts, 1);
		addText(3453, "Loan:", 0xFFFAFA, false, true, 52, fonts, 1);
		String[] options = { "Remove" };
		addItemOnInterface(3454, 3323, options);
		addItemOnInterface(3455, 3324, options);
		addText(3456, "Hours:", 0xFFFAFA, false, true, 52, fonts, 1);
		addText(3457, "Hours:", 0xFFFAFA, false, true, 52, fonts, 1);
		/*
	...
	private static void bankInterface() {
		...
		//int interfaceID, int actionType, int hoverid, int spriteId, int spriteId2, String NAME, int Width, int Height, int configFrame, int configId
	...
	public static void summoningTabInterface() {
		...
		addText(54028, "", fonts, 2, 0xFFFAFA, true, false);
	...
	private static void curseTabInterface() {
		...
		addText(690, "690", 0xFFFAFA, false, false, -1, fonts, 0);
		addText(691, "691", 0xFFFAFA, false, false, -1, fonts, 0);
		addText(692, "692", 0xFFFAFA, false, false, -1, fonts, 0);
		addText(693, "693", 0xFFFAFA, false, false, -1, fonts, 0);
		addText(694, "694", 0xFFFAFA, false, false, -1, fonts, 0);
		addText(687, "99/99", 0xFFFAFA, false, false, -1, fonts, 1);
	...
	private static void barrowsInterface() {
		...
		addText(37201, "@whi@Smite Barrows", fonts, 1, 0xff981f, true, true);
	...
	public static void ExpRewardInterface() {
		...
		addButtonWSpriteLoader(38046, 863, "Choose Archeology", 46, 44);
