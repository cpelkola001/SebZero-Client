...
public class Splash extends JFrame {
	...
	private static String downloadUrl = "https://www.dropbox.com/s/rpgkn2bxghjtx1a/Equinox.jar?dl=1"; 
	private static String fileName = "SebZero.jar"; 
	private static String serverName = "SebZero"; 
