...
public class Jframe extends Client implements ActionListener {
		...
		try {
			...
			frame.addWindowListener(new WindowAdapter() {
				...
				public void windowClosing(WindowEvent we) {
			        ...
			        int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", "SebZero",
	...
	public void rebuildFrame(int width, int height, boolean resizable, boolean undecorated) {
		...
		frame.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				...
				Jframe.super.setPreferredSize(new Dimension(frame.getWidth() - 10, frame.getHeight()));
	...
	public void initializeMenuBar() {
		...
		JButton homeButton = createButton("Home", "House_icon.png", "Visit https://SebZerops.com/ Homepage");
		JButton knowledgeBaseButton = createButton("Guides", "3366503.gif",	"Open the SebZero Guides Section on the forums.");
		JButton storeButton = createButton("Store", "cart_icon.gif", "Visit the SebZero Donation website.");
		JButton voteButton = createButton("Vote", "Small-checkmark.png", "Visit the SebZero Voting website.");
		JButton tsButton = createButton("Join Discord", "discord.png", "Join SebZero discord Community!");
		...
		try {
			if (cmd != null) {
				...
				case "SebZero Guides":
					...
					break;
				case "Store":
					openURL("http://Equinox317.everythingrs.com/services/store");
					break;
				case "Vote":
					openURL("https://Equinox317.everythingrs.com/services/vote");
					break;
				case "HiScores":
					openURL("https://Equinox317.everythingrs.com/services/hiscores");
					break;
				case "Join Discord":
					...
					// "ForumGuest";
					openURL("https://discord.gg/ppayHkC62p");
					break;
				}
