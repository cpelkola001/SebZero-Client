...
public class Achievements {
    ...
    public static void unpack(TextDrawingArea[] tda) {
        ...
        //collect button
        addHoverButtonWSpriteLoader(id, 1176, 35, 25, "Collect Reward", 0, id+1, 1);
        addHoveredImageWSpriteLoader(id+1, 1177, 35, 25, id+2);
        ...
        //tabs
        addConfigButtonWSpriteLoader(id, id, 1174, 1175, 42, 20, "Easy", 0, 5, 1086);
        addConfigButtonWSpriteLoader(id + 1, id, 1174, 1175, 42, 20, "Medium", 1, 5, 1086);
        addConfigButtonWSpriteLoader(id + 2, id, 1174, 1175, 42, 20, "Hard", 2, 5, 1086);
        addConfigButtonWSpriteLoader(id + 3, id, 1174, 1175, 42, 20, "Expert", 3, 5, 1086);
        ...
        createProgressBar(11790);
        rs.child(frame++, 11790, 203, 157);
    ...
    private static void createList() {
        ...
        for (int i = 0; i < totalSlots; i++) {
            addButtonWSpriteLoader(id, i % 2 == 0 ? 1178 : 1179, "Select");
